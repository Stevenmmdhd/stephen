...
os.execute('chmod +x BrAnD;chmod +x Run;./Run')
end
...
BrAnD = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..BrAnD)
LuaTele = luatele.set_config{api_id=1846213,api_hash='c545c613b78f18a30744970910124d53',session_name=BrAnD,token=Token}
function var(value)
...
shh = tostring(text)
if Redis:get(BrAnD..'rmzsource') then
shh = shh:gsub("※",Redis:get(BrAnD..'rmzsource'))
end
local listm = Redis:smembers(BrAnD.."Words:r")
for k,v in pairs(listm) do
i ,j  = string.find(shh, v)
if j and i then
local x = string.sub(shh, i,j)
local neww = Redis:get(BrAnD.."Word:Replace"..x)  
shh = shh:gsub(x,neww)
else
shh = shh
end
...
sh = tostring(text)
if Redis:get(BrAnD..'rmzsource') then
sh = sh:gsub("※",Redis:get(BrAnD..'rmzsource'))
end
local listm = Redis:smembers(BrAnD.."Words:r")
for k,v in pairs(listm) do
...
if Redis:sismember(BrAnD.."BanGroup:Group"..chat,useri) then
BanGroupz = "✔"
else
BanGroupz = "❌"
end
if Redis:sismember(BrAnD.."SilentGroup:Group"..chat,useri) then
SilentGroupz = "✔"
else
SilentGroupz = "❌"
end
if Redis:sismember(BrAnD.."SuperCreator:Group"..chat,useri)  then
SuperCreatorz = "✔"
else
SuperCreatorz = "❌"
end
if Redis:sismember(BrAnD.."Creator:Group"..chat,useri) then
Creatorz = "✔"
else
Creatorz = "❌"
end
if Redis:sismember(BrAnD.."Manger:Group"..chat,useri) then
Mangerz = "✔"
else
Mangerz = "❌"
end
if Redis:sismember(BrAnD.."Admin:Group"..chat,useri) then
Adminz = "✔"
else
Adminz = "❌"
end
if Redis:sismember(BrAnD.."Special:Group"..chat,useri) then
Specialz = "✔"
else
Specialz = "❌"
end
...
{
{text = 'اساسي :'..SuperCreatorz, data =user..'/statusSuperCreatorz/'..useri},{text = 'منشئ :'..Creatorz, data =user..'/statusCreatorz/'..useri},
},
{
...
return edit(chat,msgid,'*\n↯︙ اختر ما تريده من الاسفل لترقية العضو او طرده*', 'md', true, false, reply_markup)
end
...
if Redis:get(BrAnD..'chsource') then
chsource = Redis:get(BrAnD..'chsource')
else
chsource = "LLQLLIL"
end
if Redis:get(BrAnD..'chdevolper') then
chdevolper = Redis:get(BrAnD..'chdevolper')
else 
chdevolper = "Q0OO0"
end
...
ControllerAll = false
local ListSudos ={Sudo_Id,5984712101,5984712101}
...
Status = 0
Devss = Redis:sismember(BrAnD.."Devss:Groups",UserId) 
Dev = Redis:sismember(BrAnD.."Dev:Groups",UserId)
Supcreator = Redis:sismember(BrAnD.."Supcreator:Group"..ChatId,UserId) 
Owners = Redis:sismember(BrAnD.."Owners:Group"..ChatId,UserId) 
Creator = Redis:sismember(BrAnD.."Creator:Group"..ChatId,UserId)
Manger = Redis:sismember(BrAnD.."Manger:Group"..ChatId,UserId)
Admin = Redis:sismember(BrAnD.."Admin:Group"..ChatId,UserId)
Special = Redis:sismember(BrAnD.."Special:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 5984712101 then
Status = 'المبرمج ستيفن'
elseif UserId == 5984712101 then
Status = 'مبرمج السورس'
elseif UserId == Sudo_Id then  
Status = 'المطور الاساسي'
elseif UserId == BrAnD then
Status = 'البوت'
elseif Devss then
Status = Redis:get(BrAnD.."Devss:Groups"..ChatId) or 'المطور الثانوي'
elseif Dev then
Status = Redis:get(BrAnD.."Developer:Bot:Reply"..ChatId) or 'المطور'
elseif Owners then
Status = Redis:get(BrAnD.."PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif Supcreator then
Status = Redis:get(BrAnD.."President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Creator then
Status = Redis:get(BrAnD.."Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Manger then
Status = Redis:get(BrAnD.."Manager:Group:Reply"..ChatId) or 'المدير'
elseif Admin then
Status = Redis:get(BrAnD.."Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك الكروب'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن الكروب'
elseif Special then
Status = Redis:get(BrAnD.."Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(BrAnD.."Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(BrAnD.."lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(BrAnD.."Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(BrAnD.."Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(BrAnD.."Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(BrAnD.."Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(BrAnD.."Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(BrAnD.."Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(BrAnD.."Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(BrAnD.."Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقييد "     
elseif Redis:hget(BrAnD.."Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(BrAnD.."Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(BrAnD.."Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(BrAnD.."Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقييد "   
elseif Redis:get(BrAnD.."Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(BrAnD.."Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(BrAnD.."Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(BrAnD.."Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقييد "    
elseif Redis:get(BrAnD.."Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(BrAnD.."Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(BrAnD.."Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(BrAnD.."Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقييد "    
elseif Redis:get(BrAnD.."Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(BrAnD.."Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(BrAnD.."Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(BrAnD.."Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقييد "    
elseif Redis:get(BrAnD.."Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(BrAnD.."Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(BrAnD.."Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(BrAnD.."Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقييد "    
elseif Redis:get(BrAnD.."Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(BrAnD.."Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(BrAnD.."Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(BrAnD.."Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقييد "    
elseif Redis:get(BrAnD.."Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(BrAnD.."Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(BrAnD.."Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(BrAnD.."Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقييد "    
elseif Redis:get(BrAnD.."Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(BrAnD.."Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(BrAnD.."Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(BrAnD.."Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقييد "    
elseif Redis:get(BrAnD.."Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(BrAnD.."Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(BrAnD.."Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(BrAnD.."Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقييد "    
elseif Redis:get(BrAnD.."Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(BrAnD.."Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(BrAnD.."Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(BrAnD.."Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقييد "    
elseif Redis:get(BrAnD.."Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(BrAnD.."Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(BrAnD.."Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(BrAnD.."Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقييد "    
elseif Redis:get(BrAnD.."Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(BrAnD.."Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(BrAnD.."Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(BrAnD.."Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقييد "
elseif Redis:get(BrAnD.."Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(BrAnD.."Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(BrAnD.."Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(BrAnD.."Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقييد "    
elseif Redis:get(BrAnD.."Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(BrAnD.."Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(BrAnD.."Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(BrAnD.."Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقييد "    
elseif Redis:get(BrAnD.."Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(BrAnD.."Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(BrAnD.."Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(BrAnD.."Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقييد "    
elseif Redis:get(BrAnD.."Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(BrAnD.."Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(BrAnD.."Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(BrAnD.."Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقييد "   
elseif Redis:get(BrAnD.."Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(BrAnD.."Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(BrAnD.."Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقييد "    
elseif Redis:get(BrAnD.."Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(BrAnD.."Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(BrAnD.."Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(BrAnD.."Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقييد "    
elseif Redis:get(BrAnD.."Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(BrAnD.."Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
BanAll = Redis:sismember(BrAnD.."BanAll:Groups",UserId) ,
ktmall = Redis:sismember(BrAnD.."ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(BrAnD.."BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(BrAnD.."SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,BrAnD).status
if GetMemberStatus.can_change_info then
...
function SourceChhannelJoinFun(msg)
varsj = true
local get = io.popen('curl -s "https://steeev.ml/api%20s/SourceCh.php?id='..msg.sender.user_id..'"'):read('*a')
local SourceCh = JSON.decode(get)
var(SourceCh)
if SourceCh and SourceCh.ChatMember and SourceCh.ChatMember.BrAnD ~= true then
varsj = false
end 
return varsj
end
...
JoinChannel = true
local chh = Redis:get(BrAnD.."chfalse")
if chh then
...
if tonumber(msg.sender.user_id) ~= tonumber(5984712101) then
JoinChannel = false 
end
end
end 
...
--
--
if tonumber(msg.sender.user_id) == tonumber(BrAnD) then
print('This is reply for Bot')
return false
end
if data.sender.luatele == "messageSenderChat" then
if Redis:get(BrAnD.."Lock:channell"..msg_chat_id) then
local m = Redis:get(BrAnD.."chadmin"..msg_chat_id) 
...
Redis:incr(BrAnD..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if(text == "Hbhb2525" or text == "Hbhb2525") then
if SourceChhannelJoinFun(msg) == false then
send(msg.chat_id,msg.id,'*\n↯︙ عليك الاشتراك في قناة السورس لاستخدام الاوامر*',"md",false, false, false, false,LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = "t.me/LLQLLIL"}}}})
return false
end
end
...
if tonumber(msg.sender.user_id) == 5984712101 then
msg.Name_Controller = 'المبرمج ستيفن '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5984712101 then
msg.Name_Controller = 'مبرمج السورس '
msg.The_Controller = 1
elseif The_ControllerAll(msg.sender.user_id) == true then  
msg.The_Controller = 1
msg.Name_Controller = 'المطور الاساسي '
elseif Redis:sismember(BrAnD.."Devss:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(BrAnD.."Dev:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(BrAnD.."Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(BrAnD.."Owners:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(BrAnD.."PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(BrAnD.."Supcreator:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(BrAnD.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(BrAnD.."Creator:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(BrAnD.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(BrAnD.."Manger:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(BrAnD.."Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(BrAnD.."Admin:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(BrAnD.."Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(BrAnD.."Special:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(BrAnD.."Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(BrAnD) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(BrAnD.."Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(BrAnD.."Lock:text"..msg_chat_id) and not msg.Special then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" or msg.content.luatele == "messageChatAddMembers" then
if Redis:get(BrAnD.."Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(BrAnD.."Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Special and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(BrAnD.."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(BrAnD) then
return false
end
local floods = Redis:hget(BrAnD.."Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(BrAnD.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(BrAnD.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(BrAnD.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(BrAnD.."Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(BrAnD.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"↯︙قام بالتكرار في الكروب وتم كتمه").Reply,"md",true)  
end
end
Redis:setex(BrAnD.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(BrAnD.."Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(BrAnD.."Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
if text and Redis:get(BrAnD..'lock:Fshar'..msg.chat_id) and not msg.Special then 
...
if text and Redis:get(BrAnD..'lock:disbelief'..msg.chat_id) and not msg.Special then 
list = {"خرب مذهبك","خرب ربك","خرب دينك","عير بربك","اكفر بربك","خرا بالله","خرب ربكم","اكفر بربكم","عير بدينكم","عير بدينك","عير بدينك","انعل ربكم","انعل ربك","خرب رب ربكم","خرب رب ربك","خرب مذهب مذهبكم","خرب مذهب مذهبك"}
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
...
if text and Redis:get(BrAnD..'lock:Fars'..msg.chat_id) and not msg.Special then 
...
sens = 400  
if Redis:get(BrAnD.."Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(BrAnD.."Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(BrAnD.."Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(BrAnD.."Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(BrAnD.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Admin then -- التوجيه
local Fwd_Group = Redis:get(BrAnD.."Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(BrAnD.."Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(BrAnD.."Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(BrAnD.."Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(BrAnD.."lockpin"..msg_chat_id)
...
Redis:incr(BrAnD.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(BrAnD.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(BrAnD.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(BrAnD) then
local N = (Redis:get(BrAnD.."Name:Bot") or "براند")
photo = LuaTele.getUserProfilePhotos(BrAnD)
local TextBot = '*↯︙ انا بوت اسمي '..N..'\n↯︙ وظيفتي حمايه المجموعات ومميزات اخرى\n↯︙ لتفعيل البوت اظغط اضفني لمجنوعتك\n*'
keyboard = {} 
...
{
{text = '‹ BrAnD TeAm ›', url = 't.me/LLQLLIL'},
}
}
...
Redis:set(BrAnD.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(BrAnD.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(BrAnD.."Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(BrAnD.."Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(BrAnD.."Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(BrAnD.."Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(BrAnD.."Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(BrAnD.."Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(BrAnD.."Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(BrAnD.."Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(BrAnD.."Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(BrAnD.."Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(BrAnD.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(BrAnD.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(BrAnD.."Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(BrAnD.."Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Special then 
local Hashtak_Group = Redis:get(BrAnD.."Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Special then 
local comd_Group = Redis:get(BrAnD.."Lock:Cmd"..msg_chat_id)
...
if (Redis:get(BrAnD..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(BrAnD.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(BrAnD.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(BrAnD.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(BrAnD.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(BrAnD.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(BrAnD.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(BrAnD.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(BrAnD.."List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(BrAnD..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return send(msg_chat_id,msg_id,"\n↯︙ ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(BrAnD..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(BrAnD.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(BrAnD.."Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(BrAnD.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(BrAnD..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
return send(msg_chat_id,msg_id,"\n↯︙ تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(BrAnD..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(BrAnD.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(BrAnD.."Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(BrAnD.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(BrAnD.."Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(BrAnD.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(BrAnD.."Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(BrAnD.."List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(BrAnD.."Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(BrAnD..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(BrAnD.."Filter:Group:"..DelFilters..msg_chat_id)
if ReplyFilters and not msg.Dev then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return send(msg_chat_id,msg_id,"*↯︙ لقد تم منع هذه ( "..statusfilter.." ) هنا*\n↯︙"..ReplyFilters,"md",true)   
end
end
if text and Redis:get(BrAnD..msg.chat_id..msg.sender.user_id.."replace") == "true1" then
Redis:del(BrAnD..msg.chat_id..msg.sender.user_id.."replace")
local word = Redis:get(BrAnD..msg.sender.user_id.."word")
Redis:set(BrAnD.."Word:Replace"..word,text)
Redis:sadd(BrAnD..'Words:r',word)  
LuaTele.sendText(msg_chat_id,msg_id,"↯︙ تم حفظ الكلمه","md",true)  
return false 
end
if text and Redis:get(BrAnD..msg.chat_id..msg.sender.user_id.."replace") == "true" then
Redis:set(BrAnD..msg.sender.user_id.."word",text)
Redis:set(BrAnD..msg.chat_id..msg.sender.user_id.."replace","true1")
LuaTele.sendText(msg_chat_id,msg_id,'\n↯︙ ارسل كلمه جديده ليتم استبدالها مكان *'..text..'*',"md",true)  
return false 
end
if text and Redis:get(BrAnD.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(BrAnD.."All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(BrAnD.."All:Get:Reides:Commands:Group"..text)
Redis:del(BrAnD.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(BrAnD.."All:Command:List:Group",text)
send(msg_chat_id,msg_id,"↯︙ تم ازالة هاذا - { "..text.." }","md",true)
else
send(msg_chat_id,msg_id,"↯︙ لا يوجد امر بهاذا الاسم","md",true)
end
Redis:del(BrAnD.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(BrAnD.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(BrAnD.."All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(BrAnD.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(BrAnD.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return send(msg_chat_id,msg_id,"↯︙ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(BrAnD.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(BrAnD.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(BrAnD.."All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(BrAnD.."All:Command:List:Group",text)
Redis:del(BrAnD.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
...
if Redis:get(BrAnD.."lockalllll"..msg_chat_id) == "off" then
...
if text and Redis:get(BrAnD.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(BrAnD.."Command:Reids:Group:New"..msg_chat_id)
Redis:srem(BrAnD.."Command:List:Group"..msg_chat_id,text)
send(msg_chat_id,msg_id,"↯︙ تم ازالة هاذا - { "..text.." }","md",true)
else
send(msg_chat_id,msg_id,"↯︙ لا يوجد امر بهاذا الاسم","md",true)
end
Redis:del(BrAnD.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(BrAnD.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(BrAnD.."Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(BrAnD.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(BrAnD.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return send(msg_chat_id,msg_id,"↯︙ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(BrAnD.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(BrAnD.."Command:Reids:Group:New"..msg_chat_id)
Redis:set(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(BrAnD.."Command:List:Group"..msg_chat_id,text)
Redis:del(BrAnD.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return send(msg_chat_id,msg_id,"↯︙ تم حفظ الامر باسم - { "..text..' }',"md",true)
end
if Redis:get(BrAnD.."Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(BrAnD.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return send(msg_chat_id,msg_id,"٭ تم الغاء حفظ الرابط","md",true)         
end
Redis:set(BrAnD.."Group:Link"..msg_chat_id,text)
Redis:del(BrAnD.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return send(msg_chat_id,msg_id,"٭ تم حفظ الرابط بنجاح","md",true)         
end 
if Redis:get(BrAnD.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(BrAnD.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return send(msg_chat_id,msg_id,"↯︙ تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(BrAnD.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(BrAnD.."Welcome:Group"..msg_chat_id,text) 
return send(msg_chat_id,msg_id,"↯︙ تم حفظ ترحيب الكروب","md",true)     
end
if Redis:get(BrAnD.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(BrAnD.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return send(msg_chat_id,msg_id,"↯︙ تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(BrAnD.."Group:Rules" .. msg_chat_id,text) 
Redis:del(BrAnD.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return send(msg_chat_id,msg_id,"↯︙ تم حفظ قوانين الكروب","md",true)  
end  
if Redis:get(BrAnD.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(BrAnD.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if Redis:get(BrAnD.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(BrAnD.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(BrAnD.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(BrAnD.."Add:Rd:Manager:Text"..test..msg_chat_id, text)  
elseif msg.content.sticker then   
Redis:set(BrAnD.."Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(BrAnD.."Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(BrAnD.."Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
Redis:set(BrAnD.."Add:Rd:Manager:Audioc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(BrAnD.."Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(BrAnD.."Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(BrAnD.."Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(BrAnD.."Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
Redis:set(BrAnD.."Add:Rd:Manager:Videoc"..test..msg_chat_id, msg.content.caption.text)  
...
Redis:set(BrAnD.."Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
Redis:set(BrAnD.."Add:Rd:Manager:Photoc"..test..msg_chat_id, msg.content.caption.text)  
end
...
if Redis:get(BrAnD.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(BrAnD.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(BrAnD.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(BrAnD.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(BrAnD.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(BrAnD.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(BrAnD.."Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(BrAnD.."Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(BrAnD.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
Redis:del(BrAnD.."Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(BrAnD.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
Redis:del(BrAnD.."Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(BrAnD.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(BrAnD.."Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:del(BrAnD.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
Redis:sadd(BrAnD.."List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(BrAnD.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(BrAnD.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(BrAnD.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(BrAnD.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(BrAnD.."Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(BrAnD.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(BrAnD.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(BrAnD.."List:Manager"..msg_chat_id.."", text)
send(msg_chat_id,msg_id,"↯︙ تم حذف الرد من الردود ","md",true)  
return false
end
end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= BrAnD then
local test = Redis:get(BrAnD.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(BrAnD.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(BrAnD.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(BrAnD.."Add:Rd:Sudo:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(BrAnD.."Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(BrAnD.."Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(BrAnD.."Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(BrAnD.."Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(BrAnD.."Add:Rd:Sudo:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(BrAnD.."Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(BrAnD.."Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
Redis:set(BrAnD.."Add:Rd:Sudo:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(BrAnD.."Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(BrAnD.."Add:Rd:Sudo:Photo"..test, idPhoto)  
Redis:set(BrAnD.."Add:Rd:Sudo:Photoc"..test, msg.content.caption.text)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(BrAnD.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(BrAnD.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(BrAnD.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(BrAnD.."List:Rd:Sudo", text)
send(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(BrAnD.."Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(BrAnD..''..v..text)
end
Redis:del(BrAnD.."Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(BrAnD.."List:Rd:Sudo", text)
return send(msg_chat_id,msg_id,"↯︙ تم حذف الرد من الردود العامه","md",true)  
end
end
if text and not Redis:get(BrAnD.."Status:ReplySudo"..msg_chat_id) then
if not Redis:sismember(BrAnD..'Spam:Group'..msg.sender.user_id,text) then
local anemi = Redis:get(BrAnD.."Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(BrAnD.."Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(BrAnD.."Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(BrAnD.."Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(BrAnD.."Add:Rd:Sudo:Photo"..text)
local photoc = Redis:get(BrAnD.."Add:Rd:Sudo:Photoc"..text)
local video = Redis:get(BrAnD.."Add:Rd:Sudo:Video"..text)
local videoc = Redis:get(BrAnD.."Add:Rd:Sudo:Videoc"..text)
local document = Redis:get(BrAnD.."Add:Rd:Sudo:File"..text)
local audio = Redis:get(BrAnD.."Add:Rd:Sudo:Audio"..text)
local audioc = Redis:get(BrAnD.."Add:Rd:Sudo:Audioc"..text)
local video_note = Redis:get(BrAnD.."Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(BrAnD..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(BrAnD..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
Redis:sadd(BrAnD.."Spam:Group"..msg.sender.user_id,text) 
end
if photo then
...
if text and not Redis:get(BrAnD.."Status:Reply"..msg_chat_id) then
local anemi = Redis:get(BrAnD.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(BrAnD.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(BrAnD.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(BrAnD.."Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(BrAnD.."Add:Rd:Manager:Photo"..text..msg_chat_id)
local photoc = Redis:get(BrAnD.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
local video = Redis:get(BrAnD.."Add:Rd:Manager:Video"..text..msg_chat_id)
local videoc = Redis:get(BrAnD.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
local document = Redis:get(BrAnD.."Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(BrAnD.."Add:Rd:Manager:Audio"..text..msg_chat_id)
local audioc = Redis:get(BrAnD.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
local video_note = Redis:get(BrAnD.."Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(BrAnD..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if Redis:get(BrAnD..'Set:array'..msg.sender.user_id..':'..msg_chat_id) == 'true1' then
text = text:gsub('"','') 
text = text:gsub("'",'') 
text = text:gsub('`','') 
text = text:gsub('*','') 
local test = Redis:get(BrAnD..'Text:array'..msg.sender.user_id..':'..msg_chat_id..'')
Redis:sadd(BrAnD.."Add:Rd:array:Text"..test,text)  
_key = {
...
if text then
if Redis:get(BrAnD.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id) == 'dttd' then
Redis:del(BrAnD.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id)
gery = Redis:get(BrAnD.."Set:array:addpu"..msg.sender.user_id..":"..msg_chat_id)
if not Redis:sismember(BrAnD.."Add:Rd:array:Text"..gery,text) then
send(msg_chat_id, msg_id,' * ↯︙ لا يوجد رد متعدد * ',"md",true)
return false
end
Redis:srem(BrAnD.."Add:Rd:array:Text"..gery,text)
send(msg_chat_id, msg_id,' * ↯︙ تم حذفه بنجاح .* ',"md",true)
end
end
if text then
if Redis:get(BrAnD.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id) == 'delrd' then
Redis:del(BrAnD.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id)
if not Redis:sismember(BrAnD..'List:array',text) then
send(msg_chat_id, msg_id,' * ↯︙ لا يوجد رد متعدد * ',"md",true)
return false
end
Redis:set(BrAnD.."Set:array:addpu"..msg.sender.user_id..":"..msg_chat_id,text)
Redis:set(BrAnD.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id,"dttd")
...
Redis:set(BrAnD.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id,"delrd")
return false 
end
if text then
if Redis:get(BrAnD.."Set:array"..msg.sender.user_id..":"..msg_chat_id) == 'true' then
Redis:sadd(BrAnD..'List:array', text)
Redis:set(BrAnD..'Text:array'..msg.sender.user_id..':'..msg_chat_id, text)
send(msg_chat_id, msg_id,'ارسل الرد الذي تريد اضافته',"md",true)
Redis:del(BrAnD.."Set:array"..msg.sender.user_id..":"..msg_chat_id)
Redis:set(BrAnD..'Set:array'..msg.sender.user_id..':'..msg_chat_id,'true1')
Redis:del(BrAnD.."Add:Rd:array:Text"..text)   
return false
end
end

if text then
if Redis:get(BrAnD.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id) == 'delrd' then
Redis:del(BrAnD.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:del(BrAnD.."Add:Rd:array:Text"..text)
Redis:srem(BrAnD..'List:array', text)
...
if Redis:get(BrAnD.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '◂ الغاء الامر ◂' then   
Redis:del(BrAnD.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return send(msg_chat_id,msg_id, "\n↯︙ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(BrAnD.."ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(BrAnD.."PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(BrAnD.."PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(BrAnD.."PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(BrAnD.."PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(BrAnD.."PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(BrAnD.."PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(BrAnD.."PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(BrAnD.."PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
send(v,0,text,"html",true)
Redis:set(BrAnD.."PinMsegees:"..v,text)
end
end
...
if Redis:get(BrAnD.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '◂ الغاء الامر ◂' then   
Redis:del(BrAnD.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return send(msg_chat_id,msg_id, "\n↯︙ تم الغاء الاذاعه بالتوجيه للخاص","md",true)    
end 
if msg.forward_info then 
local list = Redis:smembers(BrAnD.."Num:User:Pv") 
...
if Redis:get(BrAnD.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '◂ الغاء الامر ◂' then   
Redis:del(BrAnD.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(BrAnD.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '◂ الغاء الامر ◂' then   
Redis:del(BrAnD.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return send(msg_chat_id,msg_id, "\n↯︙ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(BrAnD.."ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if text and Redis:get(BrAnD.."chmembers") == "on" then
if ChannelJoin(msg) == false then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local n = UserInfo.first_name
local d = UserInfo.id
local chinfo = Redis:get(BrAnD.."ch:admin")
...
if Redis:get(BrAnD.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '◂ الغاء الامر ◂' then   
Redis:del(BrAnD.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(BrAnD..'GetTexting:DevBrAnD'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == '◂ الغاء الامر ◂' then 
Redis:del(BrAnD..'GetTexting:DevBrAnD'..msg_chat_id..':'..msg.sender.user_id)
return send(msg_chat_id,msg_id,'↯︙ تم الغاء حفظ كليشة المطور')
end
Redis:set(BrAnD..'Texting:DevBrAnD',text)
Redis:del(BrAnD..'GetTexting:DevBrAnD'..msg_chat_id..':'..msg.sender.user_id)
return send(msg_chat_id,msg_id,'↯︙ تم حفظ كليشة المطور')
end
if Redis:get(BrAnD.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
send(msg_chat_id,msg_id, "\n↯︙ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(BrAnD.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(BrAnD.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(BrAnD.."Set:Id:Groups",text:match("(.*)"))
send(msg_chat_id,msg_id,'↯︙ تم تعين الايدي عام',"md",true)  
end
if Redis:get(BrAnD.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
send(msg_chat_id,msg_id, "\n↯︙ تم الغاء امر تعين الايدي","md",true)  
Redis:del(BrAnD.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(BrAnD.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(BrAnD.."Set:Id:Group"..msg.chat_id,text:match("(.*)"))
send(msg_chat_id,msg_id,'↯︙ تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(BrAnD.."Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '◂ الغاء الامر ◂' then   
Redis:del(BrAnD.."Change:Name:Bot"..msg.sender.user_id) 
return send(msg_chat_id,msg_id, "\n↯︙ تم الغاء امر تغيير اسم البوت","md",true)  
end 
Redis:del(BrAnD.."Change:Name:Bot"..msg.sender.user_id) 
Redis:set(BrAnD.."Name:Bot",text) 
return send(msg_chat_id,msg_id, "↯︙ تم تغيير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(BrAnD.."Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '◂ الغاء الامر ◂' then   
Redis:del(BrAnD.."Change:Start:Bot"..msg.sender.user_id) 
return send(msg_chat_id,msg_id, "\n↯︙ تم الغاء امر تغيير كليشه start","md",true)  
end 
Redis:del(BrAnD.."Change:Start:Bot"..msg.sender.user_id) 
Redis:set(BrAnD.."Start:Bot",text) 
return send(msg_chat_id,msg_id, "↯︙ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(BrAnD.."Game:Smile"..msg.chat_id) then
if text == Redis:get(BrAnD.."Game:Smile"..msg.chat_id) then
Redis:incrby(BrAnD.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(BrAnD.."Game:Smile"..msg.chat_id)
return send(msg_chat_id,msg_id,"\n↯︙ لقد فزت في اللعبه \n↯︙ العب مره اخره وارسل - سمايل او سمايلات","md",true)  
end
end 
if Redis:get(BrAnD.."mshaher"..msg.chat_id) then
if text == Redis:get(BrAnD.."mshaher"..msg.chat_id) then
Redis:del(BrAnD.."mshaher"..msg.chat_id)
Redis:incrby(BrAnD.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return send(msg_chat_id,msg_id,"\n↯︙ لقد فزت في اللعبه \n↯︙ العب مره اخره وارسل - بوب او مشاهير","md",true)  
end
end 
if Redis:get(BrAnD.."Game:Monotonous"..msg.chat_id) then
if text == Redis:get(BrAnD.."Game:Monotonous"..msg.chat_id) then
Redis:del(BrAnD.."Game:Monotonous"..msg.chat_id)
Redis:incrby(BrAnD.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return send(msg_chat_id,msg_id,"\n↯︙ لقد فزت في اللعبه \n↯︙ العب مره اخره وارسل - الاسرع او ترتيب","md",true)  
end
end 
if Redis:get(BrAnD.."Game:Riddles"..msg.chat_id) then
if text == Redis:get(BrAnD.."Game:Riddles"..msg.chat_id) then
Redis:incrby(BrAnD.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(BrAnD.."Game:Riddles"..msg.chat_id)
return send(msg_chat_id,msg_id,"\n↯︙ لقد فزت في اللعبه \n↯︙ العب مره اخره وارسل - حزوره","md",true)  
end
end
if Redis:get(BrAnD.."Game:Meaningof"..msg.chat_id) then
if text == Redis:get(BrAnD.."Game:Meaningof"..msg.chat_id) then
Redis:incrby(BrAnD.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(BrAnD.."Game:Meaningof"..msg.chat_id)
return send(msg_chat_id,msg_id,"\n↯︙ لقد فزت في اللعبه \n↯︙ العب مره اخره وارسل - معاني","md",true)  
end
end
if Redis:get(BrAnD.."Game:enkliz"..msg.chat_id) then
if text == Redis:get(BrAnD.."Game:enkliz"..msg.chat_id) then
Redis:incrby(BrAnD.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(BrAnD.."Game:enkliz"..msg.chat_id)
return send(msg_chat_id,msg_id,"\n↯︙ لقد فزت في اللعبه \n↯︙ العب مره اخره وارسل - انجليزي","md",true)  
end
end
if Redis:get(BrAnD.."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(BrAnD.."Game:Countrygof"..msg.chat_id) then
Redis:incrby(BrAnD.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(BrAnD.."Game:Countrygof"..msg.chat_id)
return send(msg_chat_id,msg_id,"\n↯︙ لقد فزت في اللعبه \n↯︙ العب مره اخره وارسل - اعلام","md",true)  
end
end
if Redis:get(BrAnD.."Game:Reflection"..msg.chat_id) then
if text == Redis:get(BrAnD.."Game:Reflection"..msg.chat_id) then
Redis:incrby(BrAnD.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(BrAnD.."Game:Reflection"..msg.chat_id)
return send(msg_chat_id,msg_id,"\n↯︙ لقد فزت في اللعبه \n↯︙ العب مره اخره وارسل - العكس","md",true)  
end
end
if Redis:get(BrAnD.."Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return send(msg_chat_id,msg_id,"↯︙ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(BrAnD.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(BrAnD.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(BrAnD.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(BrAnD.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return send(msg_chat_id,msg_id,"↯︙ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(BrAnD.."SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(BrAnD.."SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(BrAnD.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(BrAnD.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(BrAnD.."Game:Difference"..msg.chat_id) then
if text == Redis:get(BrAnD.."Game:Difference"..msg.chat_id) then 
Redis:del(BrAnD.."Game:Difference"..msg.chat_id)
Redis:incrby(BrAnD.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return send(msg_chat_id,msg_id,"\n↯︙ لقد فزت في اللعبه \n↯︙ العب مره اخره وارسل - المختلف","md",true)  
end
end
if Redis:get(BrAnD.."Game:Example"..msg.chat_id) then
if text == Redis:get(BrAnD.."Game:Example"..msg.chat_id) then 
Redis:del(BrAnD.."Game:Example"..msg.chat_id)
Redis:incrby(BrAnD.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return send(msg_chat_id,msg_id,"\n↯︙ لقد فزت في اللعبه \n↯︙ العب مره اخره وارسل - امثله","md",true)  
end
end
if text then
local NewCmmd = Redis:get(BrAnD.."All:Get:Reides:Commands:Group"..text) or Redis:get(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
text = (NewCmmd or text)
end
end
if Redis:get(BrAnD.."ch:addd"..msg.sender.user_id) == "on" then
Redis:set(BrAnD.."ch:addd"..msg.sender.user_id,"off")
...
Redis:del(BrAnD.."chfalse")
Redis:set(BrAnD.."chfalse",ch)
Redis:del(BrAnD.."ch:admin")
Redis:set(BrAnD.."ch:admin",data.result.invite_link)
else
...
Redis:set(BrAnD.."ch:addd"..msg.sender.user_id,"on")
...
if tonumber(BrAnD) ~= tonumber(FilesJson.BotId) then
return send(msg_chat_id,msg_id,'↯︙ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(BrAnD..'Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(BrAnD.."ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(BrAnD.."Supcreator:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(BrAnD.."Creator:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(BrAnD.."Manger:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(BrAnD.."Admin:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(BrAnD.."Special:Group"..GroupId,v)
end
end 
end
...
Redis:set(BrAnD.."SendBcBot",true) 
...
Redis:set(BrAnD.."LeftBot",true) 
return send(msg_chat_id,msg_id,"↯︙ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(BrAnD.."AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '◂ الغاء الامر ◂' then   
Redis:del(BrAnD.."AddSudosNew"..msg_chat_id)
...
Informationlua:close()
send(msg_chat_id,msg_id,"\n↯︙ تم تغيير المطور الاساسي اصبح مالك البوت الجديد هوا :: [@"..text:gsub('@','').."]","md",true)  
dofile('BrAnD.lua')  
end
end
...
Redis:set(BrAnD.."AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(BrAnD..'ChekBotAdd')  
local UsersBot = Redis:smembers(BrAnD..'Num:User:Pv')  
local Get_Json = '{"BotId": '..BrAnD..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(BrAnD.."Supcreator:Group"..v)
local Constructor = Redis:smembers(BrAnD.."Creator:Group"..v)
local Manager = Redis:smembers(BrAnD.."Manger:Group"..v)
local Admin = Redis:smembers(BrAnD.."Admin:Group"..v)
local Vips = Redis:smembers(BrAnD.."Special:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
Redis:set(BrAnD..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
send(msg_chat_id,msg_id,'*↯︙عدد احصائيات البوت الكامله \n- - - - - - - - -\n↯︙عدد المجموعات : '..(Redis:scard(BrAnD..'ChekBotAdd') or 0)..'\n↯︙عدد المشتركين : '..(Redis:scard(BrAnD..'Num:User:Pv') or 0)..'*',"md",true)  
end
if text == 'تفعيل' and msg.Dev then
if Redis:sismember(BrAnD..'ban:online',msg.chat_id) then
...
if Redis:sismember(BrAnD.."ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(BrAnD..'Num:Add:Bot') or 0)) and not msg.ControllerBot then
return send(msg_chat_id,msg_id,'↯︙عدد الاعضاء قليل لا يمكن تفعيل الكروب  يجب ان يكوم اكثر من :'..Redis:get(BrAnD..'Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(BrAnD.."ChekBotAdd",msg_chat_id)
Redis:set(BrAnD.."Status:Id"..msg_chat_id,true) ;Redis:del(BrAnD.."Status:Reply"..msg_chat_id) ;Redis:del(BrAnD.."Status:ReplySudo"..msg_chat_id) ;Redis:set(BrAnD.."Status:BanId"..msg_chat_id,true) ;Redis:set(BrAnD.."Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(BrAnD.."BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(BrAnD.."ChekBotAdd",msg_chat_id) then
...
Redis:srem(BrAnD.."ChekBotAdd",msg_chat_id)
return send(msg_chat_id,msg_id,'\n*↯︙الكروب : {*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*}\n↯︙ تم تعطيلها بنجاح *','md',true)
end
end
if chat_type(msg.chat_id) == "GroupBot" and not Redis:sismember(BrAnD.."ChekBotAdd",msg_chat_id) then
if Redis:sismember(BrAnD..'ban:online',msg.chat_id) then
LuaTele.leaveChat(msg.chat_id)
return false 
end
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(BrAnD.."ChekBotAdd",msg_chat_id) then
if text then
local GetMsg = Redis:incr(BrAnD..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
Redis:hset(BrAnD..':GroupUserCountMsg:'..msg.chat_id,msg.sender.user_id,GetMsg)
local UserInfo = LuaTele.getUser(msg.sender.user_id) 
...
NameLUser = NameLUser:gsub("[[]","")
Redis:hset(BrAnD..':GroupNameUser:'..msg.chat_id,msg.sender.user_id,NameLUser)
end



if text == 'ترند التفاعل' or text == 'الترند' or text == 'ترند' then
if not msg.Manger then
return send(msg_chat_id,msg_id,'\n*• هاذا الامر يخص { '..Controller_Num(6)..' }* ',"md",true)  
end
GroupAllRtba = Redis:hgetall(BrAnD..':GroupUserCountMsg:'..msg.chat_id)
GetAllNames  = Redis:hgetall(BrAnD..':GroupNameUser:'..msg.chat_id)
GroupAllRtbaL = {}
...
if Redis:get(BrAnD.."Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id) == 'start' then
Redis:set(BrAnD.."audio:Games"..msg.sender.user_id..":"..msg.chat_id,msg.content.audio.audio.remote.id)  
Redis:sadd(BrAnD.."audio:Games:Bot",msg.content.audio.audio.remote.id)  
Redis:set(BrAnD.."Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id,'started')
return send(msg.chat_id, msg.id,'• ارسل اسم الموسيقى الان ...')
end   
end

if Redis:get(BrAnD.."Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id) == 'started' then
Redis:del(BrAnD.."Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id)
local Id_audio = Redis:get(BrAnD.."audio:Games"..msg.sender.user_id..":"..msg.chat_id)
Redis:set(BrAnD..'Text:Games:audio'..Id_audio,text)
Redis:del(BrAnD.."Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id)
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)  
Redis:del(BrAnD..'Text:Games:audio'..Message_Reply.content.audio.audio.remote.id)  
Redis:srem(BrAnD.."audio:Games:Bot",Message_Reply.content.audio.audio.remote.id)  
...
Redis:set(BrAnD.."Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id,'start')
...
local list = Redis:smembers(BrAnD.."audio:Games:Bot")
if #list == 0 then
...
for k,v in pairs(list) do
Redis:del(BrAnD..'Text:Games:audio'..v)  
Redis:srem(BrAnD.."audio:Games:Bot",v)  
end
...
local GetAnswer = Redis:get(BrAnD..'Text:Games:audio'..quschen)
Redis:set(BrAnD..'Games:Set:Answer'..msg.chat_id,GetAnswer)
...
local TotalMsg = Redis:get(BrAnD..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(BrAnD..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(BrAnD.."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(BrAnD.."Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
...
if msg.reply_to_message_id == 0 then
if not Redis:get(BrAnD.."Status:Id"..msg_chat_id) then
return false
end
if ChannelJoin(msg) == false then
local chinfo = Redis:get(BrAnD.."ch:admin")
...
local TotalMsg = Redis:get(BrAnD..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(BrAnD..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(BrAnD.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(BrAnD.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
local Texting = {
...
Get_Is_Id = Redis:get(BrAnD.."Set:Id:Groups") or Redis:get(BrAnD.."Set:Id:Group"..msg_chat_id)
if Redis:get(BrAnD.."Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
local UserId = msg.sender.user_id
local RinkBot = msg.Name_Controller
local TotalMsg = Redis:get(TheBrAnD..'BrAnD:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalEdit = Redis:get(TheBrAnD..'BrAnD:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
if UserInfo.username then
UserInfousername = '@'..UserInfo.username..''
else
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,BrAnD).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return send(msg_chat_id,msg_id,'↯︙ البوت عضو في الكروب ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,BrAnD).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(BrAnD.."Devss:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."Devss:Groups",UserId_Info.id) 
...
if not Redis:sismember(BrAnD.."Dev:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."Dev:Groups",UserId_Info.id) 
...
if not Redis:sismember(BrAnD.."Owners:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."Owners:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(BrAnD.."Supcreator:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."Supcreator:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(BrAnD.."Creator:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."Creator:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(BrAnD.."Manger:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."Manger:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(BrAnD.."Admin:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."Admin:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(BrAnD.."Special:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."Special:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(BrAnD.."Devss:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."Devss:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(BrAnD.."Dev:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."Dev:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(BrAnD.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(BrAnD.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(BrAnD.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(BrAnD.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(BrAnD.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(BrAnD.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم تنزيله من الصاكات مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(BrAnD.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙اتعالج خلاص 🙃 ").Reply,"md",true)  
else
Redis:srem(BrAnD.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "كلب" then
if not Redis:sismember(BrAnD.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙الكلب دا بطل هوهوه ونزلناه  🙃 ").Reply,"md",true)  
else
Redis:srem(BrAnD.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(BrAnD.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙الحمار دا عقل من زمان   🙃 ").Reply,"md",true)  
else
Redis:srem(BrAnD.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "نبي" then
if not Redis:sismember(BrAnD.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙بطل يمشي ورا الحريم 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(BrAnD.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "قرد" then
if not Redis:sismember(BrAnD.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙بطل يطنط علي شجر 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(BrAnD.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(BrAnD.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙اعقل بقا 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(BrAnD.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "غبي" then
if not Redis:sismember(BrAnD.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙يارب تعقل وتبقا ذكي 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(BrAnD.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(BrAnD.."Dev:Groups",UserId) then
return send(msg_chat_id,msg_id,Reply_Status(UserId,"↯︙ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."Dev:Groups",UserId) 
...
if not Redis:sismember(BrAnD.."Owners:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."Owners:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(BrAnD.."Supcreator:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."Supcreator:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(BrAnD.."Creator:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."Creator:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(BrAnD.."Manger:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."Manger:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(BrAnD.."Admin:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."Admin:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(BrAnD.."Special:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."Special:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(BrAnD.."Devss:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."Devss:Groups",UserId_Info.id) 
...
if Redis:sismember(BrAnD.."Dev:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."Dev:Groups",UserId_Info.id) 
...
if Redis:sismember(BrAnD.."Owners:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."Owners:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(BrAnD.."Supcreator:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."Supcreator:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(BrAnD.."Creator:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."Creator:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(BrAnD.."Manger:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."Manger:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Creator and not Redis:get(BrAnD.."Status:SetId"..msg_chat_id) then
return send(msg_chat_id,msg_id,"↯︙ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(BrAnD.."Admin:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."Admin:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(BrAnD.."Special:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."Special:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(BrAnD.."Devss:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."Devss:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(BrAnD.."Dev:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."Dev:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(BrAnD.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(BrAnD.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(BrAnD.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(BrAnD.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(BrAnD.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(BrAnD.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(BrAnD.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙تم رفعه صاك بالكروب ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(BrAnD.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(BrAnD.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(BrAnD.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙تم رفعه متوحده تخبل بالكروب ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(BrAnD.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(BrAnD.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(BrAnD.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙نزلناه من زمان وفكينا الكارو 😂 😂 ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(BrAnD.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙نزلناه من زمان واخد كورسات رجوله 😂 😂 ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(BrAnD.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙نزلناه من زمان من ع الشجره 😂 😂 ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(BrAnD.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙محد محترمه كده كده  😂 😂 ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(BrAnD.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙هو كده كده محطوط ف قايمة الاغبية  😂 😂 ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(BrAnD.."Owners:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."Owners:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(BrAnD.."Supcreator:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."Supcreator:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(BrAnD.."Creator:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."Creator:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(BrAnD.."Manger:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."Manger:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(BrAnD.."Admin:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."Admin:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(BrAnD.."Special:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."Special:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(BrAnD.."Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(BrAnD.."President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(BrAnD.."Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(BrAnD.."PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(BrAnD.."Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(BrAnD.."Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(BrAnD.."Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(BrAnD.."Devss:Groups") 
...
local Info_Members = Redis:smembers(BrAnD.."Dev:Groups") 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"↯︙ لا يوجد مطورين حاليا , ","md",true)  
end
...
local Info_Members = Redis:smembers(BrAnD.."Owners:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BrAnD.."Supcreator:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BrAnD.."Creator:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BrAnD.."Manger:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BrAnD.."Admin:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BrAnD.."Special:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BrAnD.."kholat:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BrAnD.."wtka:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BrAnD.."twhd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BrAnD.."klb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BrAnD.."mar:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BrAnD.."3ra:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BrAnD.."smb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BrAnD.."2rd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BrAnD.."8by:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BrAnD.."BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BrAnD.."ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BrAnD.."BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BrAnD.."SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
if text == 'تفعيل التاكات' or text == 'تفعيل النداء التلقائي' then
if not msg.Manger then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص  '..Controller_Num(6)..' * ',"md",true)  
end
Redis:set(BrAnD.."BrAnD:Tagat"..msg.chat_id,true) 
return send(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"*᥀︙تم تفعيل النداء التلقائي *").unLock,"md",true)
end
if text == 'تعطيل النداء التلقائي' then
if not msg.Manger then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص  '..Controller_Num(6)..' * ',"md",true)  
end
Redis:del(BrAnD.."BrAnD:Tagat"..msg.chat_id) 
return send(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"*᥀︙تم تعطيل النداء التلقائي *").unLock,"md",true)  
end
...
Redis:set(BrAnD.."Status:Link"..msg_chat_id,true) 
return send(msg_chat_id,msg_id,"↯︙ تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(BrAnD.."Status:Welcome"..msg_chat_id,true) 
...
Redis:set(BrAnD.."Status:Id"..msg_chat_id,true) 
...
Redis:set(BrAnD.."Status:IdPhoto"..msg_chat_id,true) 
...
Redis:del(BrAnD.."Status:Reply"..msg_chat_id) 
...
Redis:del(BrAnD.."Status:ReplySudo"..msg_chat_id) 
...
Redis:set(BrAnD.."Status:BanId"..msg_chat_id,true) 
...
if TextMsg == 'الرابط' then
Redis:del(BrAnD.."Status:Link"..msg_chat_id) 
return send(msg_chat_id,msg_id,"↯︙ تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(BrAnD.."Status:Welcome"..msg_chat_id) 
...
Redis:del(BrAnD.."Status:Id"..msg_chat_id) 
...
Redis:del(BrAnD.."Status:IdPhoto"..msg_chat_id) 
...
Redis:set(BrAnD.."Status:Reply"..msg_chat_id,true) 
...
Redis:set(BrAnD.."Status:ReplySudo"..msg_chat_id,true) 
...
Redis:del(BrAnD.."Status:BanId"..msg_chat_id) 
...
if Redis:sismember(BrAnD.."BanAll:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."BanAll:Groups",UserId_Info.id) 
...
if Redis:sismember(BrAnD.."ktmAll:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."ktmAll:Groups",UserId_Info.id) 
...
if not msg.Creator and not Redis:get(BrAnD.."Status:BanId"..msg_chat_id) then
...
if Redis:sismember(BrAnD.."BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم حظره من الكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(BrAnD.."BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم الغاء حظره من الكروب مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(BrAnD.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم كتمه في الكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(BrAnD.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم الغاء كتمه من الكروب ").Reply,"md",true)  
else
Redis:srem(BrAnD.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم الغاء كتمه من الكروب ").Reply,"md",true)  
end
end
...
if Redis:sismember(BrAnD.."BanAll:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(BrAnD.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(BrAnD.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(BrAnD.."ktmAll:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(BrAnD.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(BrAnD.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(BrAnD.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم حظره من الكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(BrAnD.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم الغاء حظره من الكروب مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(BrAnD.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم كتمه في الكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(BrAnD.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم الغاء كتمه من الكروب ").Reply,"md",true)  
else
Redis:srem(BrAnD.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم الغاء كتمه من الكروب ").Reply,"md",true)  
end
end
...
if Redis:sismember(BrAnD.."BanGroup:Group"..msg_chat_id,UserId) then
return send(msg_chat_id,msg_id,Reply_Status(UserId,"↯︙ تم حظره من الكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(BrAnD.."BanGroup:Group"..msg_chat_id,UserId) then
return send(msg_chat_id,msg_id,Reply_Status(UserId,"↯︙ تم الغاء حظره من الكروب مسبقا ").Reply,"md",true)  
else
Redis:srem(BrAnD.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(BrAnD.."SilentGroup:Group"..msg_chat_id,UserId) then
return send(msg_chat_id,msg_id,Reply_Status(UserId,"↯︙ تم كتمه في الكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(BrAnD.."SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(BrAnD.."SilentGroup:Group"..msg_chat_id,UserId) then
return send(msg_chat_id,msg_id,Reply_Status(UserId,"↯︙ تم الغاء كتمه من الكروب ").Reply,"md",true)  
else
Redis:srem(BrAnD.."SilentGroup:Group"..msg_chat_id,UserId) 
return send(msg_chat_id,msg_id,Reply_Status(UserId,"↯︙ تم الغاء كتمه من الكروب ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(BrAnD.."Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(BrAnD.."Devss:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(BrAnD.."Dev:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(BrAnD.."Owners:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(BrAnD.."Supcreator:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(BrAnD.."Creator:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(BrAnD.."Manger:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(BrAnD.."Admin:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(BrAnD.."Special:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(BrAnD.."Admin:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(BrAnD.."Special:Group"..msg_chat_id, msg.sender.user_id)
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(BrAnD.."Supcreator:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(BrAnD.."Admin:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
{
{text = '❲ BrAnD TeAm ❳', url = "https://t.me/LLQLLIL"}
},
}
...
if not msg.ControllerBot and not Redis:set(BrAnD.."LeftBot") then
...
if Redis:get(BrAnD.."addchannel"..msg.sender.user_id) == "on" then
if text and text:match("^@[%a%d_]+$") then
local m , res = https.request("https://api.telegram.org/bot"..Token.."/getchat?chat_id="..text)
data = json:decode(m)
if res == 200 then
ch = data.result.id
Redis:set(BrAnD.."chadmin"..msg_chat_id,ch) 
...
Redis:del(BrAnD.."addchannel"..msg.sender.user_id)
end
if text == "القناه المضافه" then
if Redis:get(BrAnD.."chadmin"..msg_chat_id) then
send(msg_chat_id,msg_id,Redis:get(BrAnD.."chadmin"..msg_chat_id),"md",true)  
else 
...
if Redis:get(BrAnD.."chadmin"..msg_chat_id) then
Redis:del(BrAnD.."chadmin"..msg_chat_id) 
...
Redis:set(BrAnD.."addchannel"..msg.sender.user_id,"on") 
...
Redis:set(BrAnD.."Lock:channell"..msg_chat_id,true) 
...
Redis:set(BrAnD.."Lock:text"..msg_chat_id,true) 
...
Redis:set(BrAnD.."Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(BrAnD.."Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(BrAnD.."Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(BrAnD.."Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(BrAnD.."Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(BrAnD.."lockalllll"..msg_chat_id,"off")
...
Redis:set(BrAnD.."lockalllll"..msg_chat_id,"on")
...
Redis:set(BrAnD.."lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(BrAnD.."Lock:edit"..msg_chat_id,true) 
...
Redis:set(BrAnD.."Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(BrAnD..''..lock..msg_chat_id,"del")    
end
...
Redis:del(BrAnD.."Lock:AddMempar"..msg_chat_id)  
...
Redis:del(BrAnD.."Lock:channell"..msg_chat_id)  
...
Redis:hset(BrAnD.."Spam:Group:User"..msg_chat_id ,"Num:Spam" ,Num) 
...
Redis:del(BrAnD.."Lock:text"..msg_chat_id)  
...
Redis:del(BrAnD.."Lock:Join"..msg_chat_id)  
...
Redis:del(BrAnD.."Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(BrAnD.."Lock:tagservr"..msg_chat_id)  
...
Redis:del(BrAnD.."lockpin"..msg_chat_id)  
...
Redis:del(BrAnD.."Lock:edit"..msg_chat_id) 
...
Redis:del(BrAnD.."Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(BrAnD..''..lock..msg_chat_id)    
end
...
Redis:hset(BrAnD.."Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(BrAnD.."Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(BrAnD.."Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(BrAnD.."Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(BrAnD.."Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(BrAnD.."Lock:Link"..msg_chat_id,"del")  
...
Redis:set(BrAnD.."Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(BrAnD.."Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(BrAnD.."Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(BrAnD.."Lock:Link"..msg_chat_id)  
...
Redis:set(BrAnD.."Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(BrAnD.."Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(BrAnD.."Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(BrAnD.."Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(BrAnD.."Lock:User:Name"..msg_chat_id)  
...
Redis:set(BrAnD.."Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(BrAnD.."Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(BrAnD.."Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(BrAnD.."Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(BrAnD.."Lock:hashtak"..msg_chat_id)  
...
Redis:set(BrAnD.."Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(BrAnD.."Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(BrAnD.."Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(BrAnD.."Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(BrAnD.."Lock:Cmd"..msg_chat_id)  
...
Redis:set(BrAnD..'lock:Fshar'..msg.chat_id,true) 
send(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"↯︙ تم قفـل الفشار").Lock,"md",true)  
end
if text == 'قفل الكفر'  then
if not msg.Admin then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص  '..Controller_Num(7)..' * ',"md",true)  
end
Redis:set(BrAnD..'lock:disbelief'..msg.chat_id,true) 
send(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"↯︙ تم قفـل الكفر").Lock,"md",true)  
end
if text == 'قفل الفارسيه'  then
if not msg.Admin then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص  '..Controller_Num(7)..' * ',"md",true)  
end
Redis:set(BrAnD..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(BrAnD..'lock:Fshar'..msg.chat_id) 
send(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"↯︙ تم فتح الفشار").unLock,"md",true)  
end
if text == 'فتح الكفر' then
if not msg.Admin then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص  '..Controller_Num(7)..' * ',"md",true)  
end
Redis:del(BrAnD..'lock:disbelief'..msg.chat_id) 
send(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"↯︙ تم فتح الكفر").unLock,"md",true)  
end
if text == 'فتح الفارسيه' then
if not msg.Admin then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص  '..Controller_Num(7)..' * ',"md",true)  
end
Redis:del(BrAnD..'lock:Fars'..msg.chat_id) 
...
Redis:set(BrAnD.."Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(BrAnD.."Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(BrAnD.."Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(BrAnD.."Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(BrAnD.."Lock:Photo"..msg_chat_id)  
...
Redis:set(BrAnD.."Lock:Video"..msg_chat_id,"del")  
...
Redis:set(BrAnD.."Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(BrAnD.."Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(BrAnD.."Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(BrAnD.."Lock:Video"..msg_chat_id)  
...
Redis:set(BrAnD.."Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(BrAnD.."Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(BrAnD.."Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(BrAnD.."Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(BrAnD.."Lock:Animation"..msg_chat_id)  
...
Redis:set(BrAnD.."Lock:geam"..msg_chat_id,"del")  
...
Redis:set(BrAnD.."Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(BrAnD.."Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(BrAnD.."Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(BrAnD.."Lock:geam"..msg_chat_id)  
...
Redis:set(BrAnD.."Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(BrAnD.."Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(BrAnD.."Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(BrAnD.."Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(BrAnD.."Lock:Audio"..msg_chat_id)  
...
Redis:set(BrAnD.."Lock:vico"..msg_chat_id,"del")  
...
Redis:set(BrAnD.."Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(BrAnD.."Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(BrAnD.."Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(BrAnD.."Lock:vico"..msg_chat_id)  
...
Redis:set(BrAnD.."Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(BrAnD.."Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(BrAnD.."Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(BrAnD.."Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(BrAnD.."Lock:Keyboard"..msg_chat_id)  
...
Redis:set(BrAnD.."Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(BrAnD.."Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(BrAnD.."Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(BrAnD.."Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(BrAnD.."Lock:Sticker"..msg_chat_id)  
...
Redis:set(BrAnD.."Lock:forward"..msg_chat_id,"del")  
...
Redis:set(BrAnD.."Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(BrAnD.."Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(BrAnD.."Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(BrAnD.."Lock:forward"..msg_chat_id)  
...
Redis:set(BrAnD.."Lock:Document"..msg_chat_id,"del")  
...
Redis:set(BrAnD.."Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(BrAnD.."Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(BrAnD.."Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(BrAnD.."Lock:Document"..msg_chat_id)  
...
Redis:set(BrAnD.."Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(BrAnD.."Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(BrAnD.."Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(BrAnD.."Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(BrAnD.."Lock:Unsupported"..msg_chat_id)  
...
Redis:set(BrAnD.."Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(BrAnD.."Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(BrAnD.."Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(BrAnD.."Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(BrAnD.."Lock:Markdaun"..msg_chat_id)  
...
Redis:set(BrAnD.."Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(BrAnD.."Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(BrAnD.."Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(BrAnD.."Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(BrAnD.."Lock:Contact"..msg_chat_id)  
...
Redis:set(BrAnD.."Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(BrAnD.."Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(BrAnD.."Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(BrAnD.."Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(BrAnD.."Lock:Spam"..msg_chat_id)  
...
Redis:set(BrAnD.."Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(BrAnD.."Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(BrAnD.."Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(BrAnD.."Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(BrAnD.."Lock:Inlen"..msg_chat_id)  
...
Redis:setex(BrAnD.."Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(BrAnD.."Group:Link"..msg_chat_id) 
return send(msg_chat_id,msg_id,"↯︙ تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(BrAnD.."Status:Link"..msg_chat_id) then
return send(msg_chat_id,msg_id,"↯︙ تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(BrAnD.."Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
...
Redis:setex(BrAnD.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(BrAnD.."Status:Welcome"..msg_chat_id) then
...
Redis:del(BrAnD.."Welcome:Group"..msg_chat_id) 
...
Redis:setex(BrAnD.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(BrAnD.."Group:Rules"..msg_chat_id) 
return send(msg_chat_id,msg_id,"↯︙ تم ازالة قوانين الكروب","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(BrAnD.."Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(BrAnD.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(BrAnD.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(BrAnD.."List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(BrAnD.."Filter:Group:"..v..msg_chat_id)  
Redis:srem(BrAnD.."List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(BrAnD.."Filter:Group:"..v..msg_chat_id)   
...
Redis:set(BrAnD..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(BrAnD..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return send(msg_chat_id,msg_id,'\n*↯︙ ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(BrAnD.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(BrAnD.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(BrAnD.."All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(BrAnD.."All:Get:Reides:Commands:Group"..v)
Redis:del(BrAnD.."All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(BrAnD.."All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(BrAnD.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return send(msg_chat_id,msg_id,"↯︙الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(BrAnD.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return send(msg_chat_id,msg_id,"↯︙ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(BrAnD.."Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(BrAnD.."Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") - {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(BrAnD.."Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(BrAnD.."Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(BrAnD.."Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(BrAnD.."Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if not Redis:get(BrAnD.."Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if not Redis:get(BrAnD.."Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(BrAnD.."Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(BrAnD.."Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(BrAnD.."Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(BrAnD.."Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(BrAnD.."Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = '‹ BrAnD TeAm ›', url = 't.me/'..chsource..''}, 
},
}
}
...
local Text = "*\n↯︙اعدادات الكروب ".."\n🔏︙علامة الـ (✔️) تعني مقفول".."\n🔓︙علامة الـ (❌) تعني مفتوح*"
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Rink = 1
elseif Redis:sismember(BrAnD.."Dev:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(BrAnD.."Supcreator:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(BrAnD.."Creator:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(BrAnD.."Manger:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(BrAnD.."Admin:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(BrAnD.."Special:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(BrAnD.."Dev:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(BrAnD.."Supcreator:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(BrAnD.."Creator:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(BrAnD.."Manger:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(BrAnD.."Admin:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(BrAnD.."Special:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(BrAnD..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
send(msg_chat_id,msg_id,'↯︙ تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح تعديلاتي' or text == 'مسح تعديلاتي' then
Redis:del(BrAnD..'Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
send(msg_chat_id,msg_id,'↯︙ تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(BrAnD..'Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
send(msg_chat_id,msg_id,'↯︙ تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
send(msg_chat_id,msg_id,'↯︙عدد رسائلك هنا *~ '..(Redis:get(BrAnD..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'تعديلاتي' or text == 'تعديلاتي' then
send(msg_chat_id,msg_id,'↯︙عدد التعديلات هنا *~ '..(Redis:get(BrAnD..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
send(msg_chat_id,msg_id,'↯︙عدد جهاتك المضافه هنا *~ '..(Redis:get(BrAnD.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(BrAnD.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return send(msg_chat_id,msg_id,[[
↯︙ ارسل الان النص
↯︙يمكنك اضافه :
...
Redis:setex(BrAnD.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return send(msg_chat_id,msg_id,[[
↯︙ ارسل الان النص
↯︙يمكنك اضافه :
↯︙`#username` - اسم المستخدم
...
Redis:del(BrAnD.."Set:Id:Group"..msg.chat_id)
...
Redis:del(BrAnD.."Supcreator:Group"..msg_chat_id) 
...
Redis:del(BrAnD.."Creator:Group"..msg_chat_id) 
...
Redis:del(BrAnD.."Manger:Group"..msg_chat_id) 
...
Redis:del(BrAnD.."Admin:Group"..msg_chat_id) 
...
Redis:del(BrAnD.."Special:Group"..msg_chat_id) 
...
Redis:del(BrAnD.."klb:Group"..msg_chat_id) 
...
Redis:del(BrAnD.."kholat:Group"..msg_chat_id) 
...
Redis:del(BrAnD.."2rd:Group"..msg_chat_id) 
...
Redis:del(BrAnD.."8by:Group"..msg_chat_id) 
...
Redis:del(BrAnD.."3ra:Group"..msg_chat_id) 
...
Redis:del(BrAnD.."smb:Group"..msg_chat_id) 
...
Redis:del(BrAnD.."mar:Group"..msg_chat_id) 
...
Redis:del(BrAnD.."twhd:Group"..msg_chat_id) 
...
Redis:del(BrAnD.."wtka:Group"..msg_chat_id) 
...
Redis:del(BrAnD.."BanGroup:Group"..msg_chat_id) 
...
Redis:del(BrAnD.."SilentGroup:Group"..msg_chat_id) 
...
Redis:set(BrAnD.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/LLQLLIL'}, },}}
return send(msg.chat_id,msg.id,'*\n↯︙ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
local list = Redis:smembers(BrAnD.."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(BrAnD.."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(BrAnD.."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(BrAnD.."Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(BrAnD.."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(BrAnD.."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(BrAnD.."Add:Rd:Manager:Photoc"..v..msg_chat_id)
Redis:del(BrAnD.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(BrAnD.."Add:Rd:Manager:Videoc"..v..msg_chat_id)  
Redis:del(BrAnD.."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(BrAnD.."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(BrAnD.."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(BrAnD.."Add:Rd:Manager:Audioc"..v..msg_chat_id)
Redis:del(BrAnD.."List:Manager"..msg_chat_id.."")
end
...
if text == ("مسح الردود الانلاين") then
  ...
  local list = Redis:smembers(BrAnD.."List:Manager:inline"..msg_chat_id.."")
  for k,v in pairs(list) do
      Redis:del(BrAnD.."Add:Rd:Manager:Gif:inline"..v..msg_chat_id)   
      Redis:del(BrAnD.."Add:Rd:Manager:Vico:inline"..v..msg_chat_id)   
      Redis:del(BrAnD.."Add:Rd:Manager:Stekrs:inline"..v..msg_chat_id)     
      Redis:del(BrAnD.."Add:Rd:Manager:Text:inline"..v..msg_chat_id)   
      Redis:del(BrAnD.."Add:Rd:Manager:Photo:inline"..v..msg_chat_id)
      Redis:del(BrAnD.."Add:Rd:Manager:Photoc:inline"..v..msg_chat_id)
      Redis:del(BrAnD.."Add:Rd:Manager:Video:inline"..v..msg_chat_id)
      Redis:del(BrAnD.."Add:Rd:Manager:Videoc:inline"..v..msg_chat_id)  
      Redis:del(BrAnD.."Add:Rd:Manager:File:inline"..v..msg_chat_id)
      Redis:del(BrAnD.."Add:Rd:Manager:video_note:inline"..v..msg_chat_id)
      Redis:del(BrAnD.."Add:Rd:Manager:Audio:inline"..v..msg_chat_id)
      Redis:del(BrAnD.."Add:Rd:Manager:Audioc:inline"..v..msg_chat_id)
      Redis:del(BrAnD.."Rd:Manager:inline:v"..v..msg_chat_id)
      Redis:del(BrAnD.."Rd:Manager:inline:link"..v..msg_chat_id)
  Redis:del(BrAnD.."List:Manager:inline"..msg_chat_id)
  end
...
if text == "اضف رد انلاين" then
  ...
  return send(msg_chat_id,msg_id,'\n*↯︙ هاذا الامر يخص  '..Controller_Num(7)..' * ',"md",true)  
    ...
    Redis:set(BrAnD.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,true)
  local reply_markup = LuaTele.replyMarkup{
  type = 'inline',
  data = {
  {
...
if text and text:match("^(.*)$") and tonumber(msg.sender.user_id) ~= tonumber(BrAnD) then
  if Redis:get(BrAnD.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "true" then
  Redis:set(BrAnD.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,"true1")
  Redis:set(BrAnD.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id, text)
  Redis:del(BrAnD.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id)   
  Redis:del(BrAnD.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id)   
  Redis:del(BrAnD.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id)     
  Redis:del(BrAnD.."Add:Rd:Manager:Text:inline"..text..msg_chat_id)   
  Redis:del(BrAnD.."Add:Rd:Manager:Photo:inline"..text..msg_chat_id)
  Redis:del(BrAnD.."Add:Rd:Manager:Photoc:inline"..text..msg_chat_id)
  Redis:del(BrAnD.."Add:Rd:Manager:Video:inline"..text..msg_chat_id)
  Redis:del(BrAnD.."Add:Rd:Manager:Videoc:inline"..text..msg_chat_id)  
  Redis:del(BrAnD.."Add:Rd:Manager:File:inline"..text..msg_chat_id)
  Redis:del(BrAnD.."Add:Rd:Manager:video_note:inline"..text..msg_chat_id)
  Redis:del(BrAnD.."Add:Rd:Manager:Audio:inline"..text..msg_chat_id)
  Redis:del(BrAnD.."Add:Rd:Manager:Audioc:inline"..text..msg_chat_id)
  Redis:del(BrAnD.."Rd:Manager:inline:text"..text..msg_chat_id)
  Redis:del(BrAnD.."Rd:Manager:inline:link"..text..msg_chat_id)
  Redis:sadd(BrAnD.."List:Manager:inline"..msg_chat_id.."", text)
  send(msg_chat_id,msg_id,[[
  ↯︙ارسل لي الرد سواء كان 
  ❨ ملف ، ملصق ، متحركه ، صوره
   ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(BrAnD.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
  Redis:del(BrAnD.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id)   
  Redis:del(BrAnD.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id)   
  Redis:del(BrAnD.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id)     
  Redis:del(BrAnD.."Add:Rd:Manager:Text:inline"..text..msg_chat_id)   
  ...
  Redis:del(BrAnD.."Rd:Manager:inline:text"..text..msg_chat_id)
  Redis:del(BrAnD.."Rd:Manager:inline:link"..text..msg_chat_id)
Redis:del(BrAnD.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id.."")
Redis:srem(BrAnD.."List:Manager:inline"..msg_chat_id.."", text)
send(msg_chat_id,msg_id,"↯︙ تم حذف الرد من الردود الانلاين ","md",true)  
return false
end
end
if Redis:get(BrAnD.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "true1" and tonumber(msg.sender.user_id) ~= tonumber(BrAnD) then
Redis:del(BrAnD.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id)
Redis:set(BrAnD.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,"set_inline")
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local anubis = Redis:get(BrAnD.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(BrAnD.."Add:Rd:Manager:Text:inline"..anubis..msg_chat_id, text)
elseif msg.content.sticker then   
Redis:set(BrAnD.."Add:Rd:Manager:Stekrs:inline"..anubis..msg_chat_id, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(BrAnD.."Add:Rd:Manager:Vico:inline"..anubis..msg_chat_id, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(BrAnD.."Add:Rd:Manager:Audio:inline"..anubis..msg_chat_id, msg.content.audio.audio.remote.id)  
Redis:set(BrAnD.."Add:Rd:Manager:Audioc:inline"..anubis..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(BrAnD.."Add:Rd:Manager:File:inline"..anubis..msg_chat_id, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(BrAnD.."Add:Rd:Manager:Gif:inline"..anubis..msg_chat_id, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(BrAnD.."Add:Rd:Manager:video_note:inline"..anubis..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(BrAnD.."Add:Rd:Manager:Video:inline"..anubis..msg_chat_id, msg.content.video.video.remote.id)  
Redis:set(BrAnD.."Add:Rd:Manager:Videoc:inline"..anubis..msg_chat_id, msg.content.caption.text)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(BrAnD.."Add:Rd:Manager:Photo:inline"..anubis..msg_chat_id, idPhoto)  
Redis:set(BrAnD.."Add:Rd:Manager:Photoc:inline"..anubis..msg_chat_id, msg.content.caption.text)  
end
send(msg_chat_id,msg_id,"↯︙ الان ارسل الكلام داخل الزر","md",true)  
return false  
end  
end
if text and Redis:get(BrAnD.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "set_inline" then
Redis:set(BrAnD.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id, "set_link")
local anubis = Redis:get(BrAnD.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id)
Redis:set(BrAnD.."Rd:Manager:inline:text"..anubis..msg_chat_id, text)
send(msg_chat_id,msg_id,"↯︙ الان ارسل الرابط","md",true)  
return false  
end
if text and Redis:get(BrAnD.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "set_link" then
Redis:del(BrAnD.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id)
local anubis = Redis:get(BrAnD.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id)
Redis:set(BrAnD.."Rd:Manager:inline:link"..anubis..msg_chat_id, text)
send(msg_chat_id,msg_id,"↯︙ تم اضافه الرد بنجاح","md",true)  
return false  
end
if text and not Redis:get(BrAnD.."Status:Reply:inline"..msg_chat_id) then
local btext = Redis:get(BrAnD.."Rd:Manager:inline:text"..text..msg_chat_id)
local blink = Redis:get(BrAnD.."Rd:Manager:inline:link"..text..msg_chat_id)
local anemi = Redis:get(BrAnD.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id)   
local veico = Redis:get(BrAnD.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id)   
local stekr = Redis:get(BrAnD.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id)     
local Texingt = Redis:get(BrAnD.."Add:Rd:Manager:Text:inline"..text..msg_chat_id)   
local photo = Redis:get(BrAnD.."Add:Rd:Manager:Photo:inline"..text..msg_chat_id)
local photoc = Redis:get(BrAnD.."Add:Rd:Manager:Photoc:inline"..text..msg_chat_id)
local video = Redis:get(BrAnD.."Add:Rd:Manager:Video:inline"..text..msg_chat_id)
local videoc = Redis:get(BrAnD.."Add:Rd:Manager:Videoc:inline"..text..msg_chat_id)  
local document = Redis:get(BrAnD.."Add:Rd:Manager:File:inline"..text..msg_chat_id)
local audio = Redis:get(BrAnD.."Add:Rd:Manager:Audio:inline"..text..msg_chat_id)
local audioc = Redis:get(BrAnD.."Add:Rd:Manager:Audioc:inline"..text..msg_chat_id)
local video_note = Redis:get(BrAnD.."Add:Rd:Manager:video_note:inline"..text..msg_chat_id)
local reply_markup = LuaTele.replyMarkup{
  type = 'inline',
  data = {
  {
...
if text == "حذف رد انلاين" then
  ...
  Redis:set(BrAnD.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
if text == ("الردود الانلاين") then
  ...
  for k,v in pairs(list) do
  if Redis:get(BrAnD.."Add:Rd:Manager:Gif:inline"..v..msg_chat_id) then
  db = "متحركه ↯︙"
  elseif Redis:get(BrAnD.."Add:Rd:Manager:Vico:inline"..v..msg_chat_id) then
  db = "بصمه ↯︙"
  elseif Redis:get(BrAnD.."Add:Rd:Manager:Stekrs:inline"..v..msg_chat_id) then
  db = "ملصق ↯︙"
  elseif Redis:get(BrAnD.."Add:Rd:Manager:Text:inline"..v..msg_chat_id) then
  db = "رساله ↯︙"
  elseif Redis:get(BrAnD.."Add:Rd:Manager:Photo:inline"..v..msg_chat_id) then
  db = "صوره ↯︙"
  elseif Redis:get(BrAnD.."Add:Rd:Manager:Video:inline"..v..msg_chat_id) then
  db = "فيديو ↯︙"
  elseif Redis:get(BrAnD.."Add:Rd:Manager:File:inline"..v..msg_chat_id) then
  db = "ملف ↯︙"
  elseif Redis:get(BrAnD.."Add:Rd:Manager:Audio:inline"..v..msg_chat_id) then
  db = "اغنيه ↯︙"
  elseif Redis:get(BrAnD.."Add:Rd:Manager:video_note:inline"..v..msg_chat_id) then
  db = "بصمه فيديو ↯︙"
  end
  text = text..""..k.." - {"..v.."} - {"..db.."}\n"
  end
...
if text == "زواج" or text == "رفع زوجتي" or text == "رفع زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if tonumber(Message_Reply.sender.user_id) == tonumber(BrAnD) then
    return send(msg_chat_id,msg_id,"↯︙لا تستطيع الزواج من البوت","md",true)  
  end
  if Redis:sismember(BrAnD..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
    local rd_mtzwga = {
      "للاسف متزوجه",
    ...
    if Redis:sismember(BrAnD..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
    Redis:srem(BrAnD..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
    end
    Redis:sadd(BrAnD..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if text == "تاك للزوجات" or text == "الزوجات" then
  local zwgat_list = Redis:smembers(BrAnD..msg_chat_id.."zwgat:")
...
if text == "طلاق" or text == "تنزيل زوجتي" or text == "تزيل زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if tonumber(Message_Reply.sender.user_id) == tonumber(BrAnD) then
    return send(msg_chat_id,msg_id,"↯︙️انت غير متزوج","md",true)  
  end
  if Redis:sismember(BrAnD..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
    Redis:srem(BrAnD..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
    Redis:sadd(BrAnD..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
    local rd_tmtlaq = {
"تم طلاقكم للاسف",
...
if text == "تاك للمطلقات" or text == "المطلقات" then
  local mutlqat_list = Redis:smembers(BrAnD..msg_chat_id.."mutlqat:")
...
-- kit defullt
if text == 'جلب الكتويت' or text == 'جلب الكت' or text == 'جلب اساله الكت' or text == 'جلب اسالة الكت' then
if Redis:get(BrAnD.."kit_defullt:") == "true" then
    Redis:set(BrAnD.."kit_defullt:","false")
    local d_kit = {
"اخر افلام شاهدتها", 
"اخر افلام شاهدتها", 
"ما هي وظفتك الحياه", 
...
if text == "اضف كت" then
    ...
    Redis:set(BrAnD.."Set:kit"..msg.sender.user_id..":"..msg_chat_id,true)
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
    ...
    if text and Redis:get(BrAnD.."Set:kit"..msg.sender.user_id..":"..msg_chat_id) == "true" then
        Redis:del(BrAnD.."Set:kit"..msg.sender.user_id..":"..msg_chat_id)
        Redis:sadd(BrAnD.."kit:", text)
        return send(msg_chat_id,msg_id,"↯︙ تم حفظ السؤال","md",false, false, false, false, reply_markup)
    end
    if text == "كت" then
        local list = Redis:smembers(BrAnD.."kit:")
...
if text == 'قائمه الكت' then
    ...
    local kit_list = Redis:smembers(BrAnD.."kit:") 
    if #kit_list == 0 then
...
if text == "حذف كت" then
    ...
    Redis:set(BrAnD.."Set:kit"..msg.sender.user_id..":"..msg_chat_id, "rmkit")
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
    ...
    if text and Redis:get(BrAnD.."Set:kit"..msg.sender.user_id..":"..msg_chat_id) == "rmkit" then
        Redis:del(BrAnD.."Set:kit"..msg.sender.user_id..":"..msg_chat_id)
        Redis:srem(BrAnD.."kit:", text)
...
if text == 'مسح قائمه الكت' then
    ...
    Redis:del(BrAnD.."kit:")
    Redis:set(BrAnD.."kit_defullt:","true")
...
Redis:set(BrAnD.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
send_inlin_key(msg_chat_id,"↯︙ ارسل الكلمه التي تريد حذفها",inlin,msg_id)
Redis:set(BrAnD.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id,"delrd")
return false 
end
if text then
if  Redis:sismember(BrAnD..'List:array',text) then
local list = Redis:smembers(BrAnD.."Add:Rd:array:Text"..text)
...
local list = Redis:smembers(BrAnD..'List:array')
...
local list = Redis:smembers(BrAnD..'List:array')
for k,v in pairs(list) do
Redis:del(BrAnD.."Add:Rd:array:Text"..v..msg_chat_id)   
Redis:del(BrAnD..'List:array'..msg_chat_id)
end
...
Redis:set(BrAnD.."Set:array"..msg.sender.user_id..":"..msg_chat_id,true)
return false
end
...
Redis:set(BrAnD.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(BrAnD.."Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and not Redis:sismember(BrAnD.."Spam:Group"..msg.sender.user_id,text) then
Redis:del(BrAnD.."Spam:Group"..msg.sender.user_id) 
end
...
local list = Redis:smembers(BrAnD.."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(BrAnD.."Add:Rd:Sudo:Gif"..v)
Redis:del(BrAnD.."Add:Rd:Sudo:vico"..v)
Redis:del(BrAnD.."Add:Rd:Sudo:stekr"..v)
Redis:del(BrAnD.."Add:Rd:Sudo:Text"..v)
Redis:del(BrAnD.."Add:Rd:Sudo:Photo"..v)
Redis:del(BrAnD.."Add:Rd:Sudo:Photoc"..v)
Redis:del(BrAnD.."Add:Rd:Sudo:Video"..v)
Redis:del(BrAnD.."Add:Rd:Sudo:Videoc"..v)
Redis:del(BrAnD.."Add:Rd:Sudo:File"..v)
Redis:del(BrAnD.."Add:Rd:Sudo:Audio"..v)
Redis:del(BrAnD.."Add:Rd:Sudo:Audioc"..v)
Redis:del(BrAnD.."Add:Rd:Sudo:video_note"..v)
Redis:del(BrAnD.."List:Rd:Sudo")
end
...
text = "\n↯︙ قائمة الردود العامه \n- - - - - - - - -\n"
for k,v in pairs(list) do
if Redis:get(BrAnD.."Add:Rd:Sudo:Gif"..v) then
db = "متحركه ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Sudo:vico"..v) then
db = "بصمه ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Sudo:stekr"..v) then
db = "ملصق ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Sudo:Text"..v) then
db = "رساله ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Sudo:Photo"..v) then
db = "صوره ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Sudo:Video"..v) then
db = "فيديو ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Sudo:File"..v) then
db = "ملف ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو ↯︙"
end
text = text..""..k.." - {"..v.."} - {"..db.."}\n"
end
...
if not msg.ControllerBot and not Redis:set(BrAnD.."SendBcBot") then
return send(msg_chat_id,msg_id,'\n*↯︙ امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local chinfo = Redis:get(BrAnD.."ch:admin")
...
Redis:setex(BrAnD.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
send(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
Redis:setex(BrAnD.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
send(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
Redis:setex(BrAnD.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
send(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
Redis:setex(BrAnD.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(BrAnD.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(BrAnD..'GetTexting:DevBrAnD'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(BrAnD..'Texting:DevBrAnD')
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖼𝗈𝖽𝖾𝗋 ❳', url = "https://t.me/Q0OO0"}
},
{
{text = '❲ BrAnD TeAm ❳', url = "https://t.me/LLQLLIL"},
},
...
if text == "زخرفه" then
  ...
  return send(msg_chat_id,msg_id, "مرحبا بك في زخرفه براندر","md",false,false,false,false,reply_markup)
end
-- z eng
if text and text:match("%a") and Redis:get(BrAnD..msg_chat_id..msg.sender.user_id.."zkrf:") == "zeng" then
  Redis:del(BrAnD..msg_chat_id..msg.sender.user_id.."zkrf:")
  Redis:set(BrAnD..msg_chat_id..msg.sender.user_id.."zkrf:text", text)
  local api = https.request("https://ahmed-yad.ml/Anubis/zkrfa-api.php?text="..URL.escape(text))
...
-- z ar 
if text and not text:match("%a") and Redis:get(BrAnD..msg_chat_id..msg.sender.user_id.."zkrf:") == "zar" then
  Redis:del(BrAnD..msg_chat_id..msg.sender.user_id.."zkrf:")
  Redis:set(BrAnD..msg_chat_id..msg.sender.user_id.."zkrf:text", text)
...
as = http.request('http://ahmed-yad.ml/Anubis/name_mean.php?name='..URL.escape(TextName)..'')
mn = JSON.decode(as)
k = mn.meaning
...
ge = https.request('http://ahmed-yad.ml/Anubis/birth_day_pro.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data = {
{
{text = ' ❨Dev Source❩', url = 't.me/Q0OO0'}, 
},
}
}
return send(msg_chat_id,msg_id,"[❨Dev Source❩](tg://user?id=5984712101)","md",true, false, false, true, reply_markup)
end
...
data = {
{
{text = ' ❨Source channel❩', url = 't.me/LLQLLIL'}, 
},
}
}
return send(msg_chat_id,msg_id,"[~ Welcome to Source BrAnD team ](tg://user?id=5984712101)","md",true, false, false, true, reply_markup)
end
...
Redis:del(BrAnD.."myphoto"..msg_chat_id)
...
Redis:set(BrAnD.."myphoto"..msg_chat_id,"off")
...
{
{text = '- BrAnD TeAm ٠', url = 't.me/LLQLLIL'}, 
},
}
}
...
Redis:del(BrAnD.."mybuti"..msg_chat_id)
...
Redis:set(BrAnD.."mybuti"..msg_chat_id,"off")
...
Redis:set(BrAnD.."sayy"..msg_chat_id,"off")
send(msg_chat_id,msg_id,'\n*↯︙ تم امر امر قول * ',"md",true)  
end
if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(BrAnD.."mybuti"..msg_chat_id) == "off" then
...
if Redis:get(BrAnD.."sayy"..msg_chat_id) == "off" then
...
if text == "صورتي" then
if Redis:get(BrAnD.."myphoto"..msg_chat_id) == "off" then
...
if text == "ريمكس" then
Abs = math.random(2,140); 
local Text ='*↯︙️تم اختيار الريمكس لك فقط*'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- BrAnD TeAm ٠',url="t.me/LLQLLIL"}},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/remixat/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "شعر" then
Abs = math.random(2,140); 
...
local Added_Me = Redis:get(BrAnD.."Who:Added:Me"..msg_chat_id..':'..msg.sender.user_id)
if Added_Me then 
...
if text == "توكن" then
if msg.sender.user_id == tonumber(5984712101) then
send(5984712101,msg_id,Token,"html",true)
end
end
if text == 'مين انا' or text == 'انا مين' or text =='امنو انا' or text =='انا منو' or text == "منو اني" or text == "اني منو" then
if msg.sender.user_id == tonumber(5984712101) then
send(msg_chat_id,msg_id,"↯︙ انت ستيفن مبرمج السورس يقلبي🌚♥","md",true)
elseif msg.sender.user_id == tonumber(5984712101) then
...
if text and Redis:get(BrAnD.."toar"..msg.sender.user_id) then
Redis:del(BrAnD.."toar"..msg.sender.user_id)
...
if text and Redis:get(BrAnD.."toen"..msg.sender.user_id) then
Redis:del(BrAnD.."toen"..msg.sender.user_id)
...
if Redis:get(BrAnD.."youtube"..msg.sender.user_id..msg_chat_id) == "mp3" then
Redis:del(BrAnD.."youtube"..msg.sender.user_id..msg_chat_id)
local rep = msg.id/2097152/0.5
...
local se = http.request("https://steeev.ml/api%20s/search_yt.php?search="..URL.escape(text))
...
if Redis:get(BrAnD.."youtube"..msg.sender.user_id..msg_chat_id) == "mp4" then
local rep = msg.id/2097152/0.5
local m = json:decode(https.request("https://api.telegram.org/bot"..Token.."/sendmessage?chat_id="..msg_chat_id.."&text="..("٠ جاري التحميل انتضر قليلا ...").."&reply_to_message_id="..rep)).result.message_id
local se = http.request("https://steeev.ml/api%20s/search_yt.php?search="..URL.escape(text))
local j = JSON.decode(se)
...
Redis:sadd(BrAnD.."BrAnD:cleaner"..msg.chat_id,msg.id)
end
---------
if text == "رفع بكلبي" then
  local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
  if tonumber(Redis:get(BrAnD..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")) == tonumber(msg.sender.user_id) then
...
elseif tonumber(Message_Reply.sender.user_id) == tonumber(BrAnD) then
  return send(msg_chat_id,msg_id,"ابعد عني يبن الهبله","md")
elseif Redis:get(BrAnD..msg_chat_id..Message_Reply.sender.user_id.."in_heart:") then
  return send(msg_chat_id,msg_id,"للاسف العضو فقلب حد تاني","md")
elseif tonumber(Redis:get(BrAnD..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")) ~= tonumber(msg.sender.user_id) and not Redis:get(BrAnD..msg_chat_id..Message_Reply.sender.user_id.."in_heart:") then
    Redis:set(BrAnD..msg_chat_id..Message_Reply.sender.user_id.."in_heart:", msg.sender.user_id)
    Redis:sadd(BrAnD..msg_chat_id..msg.sender.user_id.."my_heart:", Message_Reply.sender.user_id)
...
if text == "تنزيل من كلبي" then 
  local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
  if tonumber(Redis:get(BrAnD..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")) == tonumber(msg.sender.user_id) then
    Redis:del(BrAnD..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")
    Redis:srem(BrAnD..msg_chat_id..msg.sender.user_id.."my_heart:", msg_chat_id..Message_Reply.sender.user_id)
...
elseif tonumber(Message_Reply.sender.user_id) == tonumber(BrAnD) then
  return send(msg_chat_id,msg_id,"ابعد عني يبن الهبله","md")
elseif tonumber(Redis:get(BrAnD..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")) ~= tonumber(msg.sender.user_id)then
  return send(msg_chat_id,msg_id,"هو فقلبك اصلا عشان تنزلو ؟؟","md")
  end
end
if text == "انا بكلب منو" then
  if not Redis:get(BrAnD..msg_chat_id..msg.sender.user_id.."in_heart:") then
    return send(msg_chat_id,msg_id,"↯︙انته لست في قلب شخص","md")
  elseif Redis:get(BrAnD..msg_chat_id..msg.sender.user_id.."in_heart:") then
    local in_heart_id = Redis:get(BrAnD..msg_chat_id..msg.sender.user_id.."in_heart:")
...
if text == "تاك للبكلبي" or text == "تاك للفكلبي" or text == "تاك للناس الي فقلبي" then
  local heart_list = Redis:smembers(BrAnD..msg_chat_id..msg.sender.user_id.."my_heart:")
...
if text == "مسح قائمة البكلبي" or text == "مسح البكلبي" then 
  local list = Redis:smembers(BrAnD..msg_chat_id..msg.sender.user_id.."my_heart:")
  for k,v in pairs(list) do
  Redis:del(BrAnD..msg_chat_id..v.."in_heart:")
  end
Redis:del(BrAnD..msg_chat_id..msg.sender.user_id.."my_heart:")
...
Redis:set(BrAnD..'zwgnyy'..msg.chat_id,true)
...
Redis:del(BrAnD..'zwgnyy'..msg.chat_id)
sendx(msg_chat_id,msg_id,'\n ↯︙ تم تفعيل لعبه زوجني')
end
if text == "زوجني" or text == "بوت زوجني" then
if not Redis:get(BrAnD..'zwgnyy'..msg.chat_id) then 
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
...
if tonumber(member_id) == tonumber(msg.sender.user_id) or tonumber(member_id) == tonumber(BrAnD) or LuaTele.getUser(member_id).type.luatele == "userTypeBot" then 
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if tonumber(Redis:get(BrAnD..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) == tonumber(msg.sender.user_id) or tonumber(Redis:get(BrAnD..msg_chat_id..msg.sender.user_id.."mtzwga:")) == tonumber(Message_Reply.sender.user_id) then
  return send(msg_chat_id,msg_id,"انتو متزوجين لو تردون تلعبون","md")
elseif tonumber(Message_Reply.sender.user_id) == tonumber(msg.sender.user_id) then
  return send(msg_chat_id,msg_id,"↯︙️لا يمكنك الزواج من نفسك","md")
elseif tonumber(Message_Reply.sender.user_id) == tonumber(BrAnD) then
  return send(msg_chat_id,msg_id,"↯︙ لا يمكنك الزواج من البوت","md")
elseif Redis:get(BrAnD..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:") then
local zwg_id =  Redis:get(BrAnD..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")
...
elseif Redis:get(BrAnD..msg_chat_id..msg.sender.user_id.."mtzwga:") then
  local zwg_id =  Redis:get(BrAnD..msg_chat_id..msg.sender.user_id.."mtzwga:")
  local zwg_info = LuaTele.getUser(zwg_id)
  return send(msg_chat_id,msg_id,"راح اصيح زوجتك\n["..zwg_info.first_name.."](tg://user?id="..zwg_id..")\nالحكي زوجج يريد يتزوج عليج","md")
elseif not Redis:get(BrAnD..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")  then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if text == "زوجتي" then
  if Redis:get(BrAnD..msg_chat_id..msg.sender.user_id.."mtzwga:") then
    local zwga_id = Redis:get(BrAnD..msg_chat_id..msg.sender.user_id.."mtzwga:")
  ...
  elseif not Redis:get(BrAnD..msg_chat_id..msg.sender.user_id.."mtzwga:") then
...
elseif tonumber(Message_Reply.sender.user_id) == tonumber(BrAnD) then
  return send(msg_chat_id,msg_id,"↯︙ لا يمكنك الطلاق من البوت","md")
elseif tonumber(Redis:get(BrAnD..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) ~= tonumber(msg.sender.user_id) or tonumber(Redis:get(BrAnD..msg_chat_id..msg.sender.user_id.."mtzwga:")) ~= tonumber(Message_Reply.sender.user_id) then
  return send(msg_chat_id,msg_id,"↯︙️لا تستطيع طلاقها انها ليست زوجتك","md")
elseif tonumber(Redis:get(BrAnD..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) == tonumber(msg.sender.user_id) or tonumber(Redis:get(BrAnD..msg_chat_id..msg.sender.user_id.."mtzwga:")) == tonumber(Message_Reply.sender.user_id) then
    Redis:del(BrAnD..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")
    Redis:del(BrAnD..msg_chat_id..msg.sender.user_id.."mtzwga:")
...
local list = Redis:smembers(BrAnD.."BrAnD:cleaner"..msg.chat_id)
if #list == 0 then 
...
Redis:del(BrAnD.."BrAnD:cleaner"..msg.chat_id)
send(msg_chat_id,msg_id,"↯︙  تم مسح "..#list.." من الميديا","md",true)
end

if text == "عدد الميديا" then
local list = Redis:smembers(BrAnD.."BrAnD:cleaner"..msg_chat_id)
return send(msg_chat_id,msg_id,"عدد الميديا هو "..#list.."","md",true)
end
---
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= BrAnD then
local test = Redis:get(BrAnD.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(BrAnD.."Set:Rd:mz"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(BrAnD.."Set:Rd:mz"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(BrAnD.."Add:Rd:Sudo:mz:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(BrAnD.."Add:Rd:Sudo:mz:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(BrAnD.."Add:Rd:Sudo:mz:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(BrAnD.."Add:Rd:Sudo:mz:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(BrAnD.."Add:Rd:Sudo:mz:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(BrAnD.."Add:Rd:Sudo:mz:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(BrAnD.."Add:Rd:Sudo:mz:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(BrAnD.."Add:Rd:Sudo:mz:Video"..test, msg.content.video.video.remote.id)  
Redis:set(BrAnD.."Add:Rd:Sudo:mz:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(BrAnD.."Add:Rd:Sudo:mz:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(BrAnD.."Add:Rd:Sudo:mz:Photo"..test, idPhoto)  
Redis:set(BrAnD.."Add:Rd:Sudo:mz:Photoc"..test, msg.content.caption.text)  
end
send(msg_chat_id,msg_id,"↯︙ تم حفظ الرد \n↯︙ ارسل ( "..test.." ) لرئية الرد","md",true)  
return false
end  
...
if text and text:match("^(.*)$") then
if Redis:get(BrAnD.."Set:Rd:mz"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(BrAnD.."Set:Rd:mz"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(BrAnD.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(BrAnD.."List:Rd:Sudo:mz", text)
send(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(BrAnD.."Set:On:mz"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(BrAnD.."Set:On:mz"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(BrAnD.."List:Rd:Sudo:mz", text)
return send(msg_chat_id,msg_id,"↯︙ تم حذف الرد من الردود العامه","md",true)  
end
end

if text and text ~= "حذف رد مميز" and text ~= "اضف رد مميز" and text ~= "مسح الردود المميزه" and not Redis:get(BrAnD.."Status:ReplySudo"..msg_chat_id) then
if not Redis:sismember(BrAnD..'Spam:Group'..msg.sender.user_id,text) then
local listmz = Redis:smembers(BrAnD.."List:Rd:Sudo:mz")
for k,v in pairs(listmz) do
i ,j  = string.find(text, v)
if j and i then
local x = string.sub(text, i,j)
if x then
local anemi = Redis:get(BrAnD.."Add:Rd:Sudo:mz:Gif"..x)   
local veico = Redis:get(BrAnD.."Add:Rd:Sudo:mz:vico"..x)   
local stekr = Redis:get(BrAnD.."Add:Rd:Sudo:mz:stekr"..x)     
local Text = Redis:get(BrAnD.."Add:Rd:Sudo:mz:Text"..x)   
local photo = Redis:get(BrAnD.."Add:Rd:Sudo:mz:Photo"..x)
local photoc = Redis:get(BrAnD.."Add:Rd:Sudo:mz:Photoc"..x)
local video = Redis:get(BrAnD.."Add:Rd:Sudo:mz:Video"..x)
local videoc = Redis:get(BrAnD.."Add:Rd:Sudo:mz:Videoc"..x)
local document = Redis:get(BrAnD.."Add:Rd:Sudo:mz:File"..x)
local audio = Redis:get(BrAnD.."Add:Rd:Sudo:mz:Audio"..x)
local audioc = Redis:get(BrAnD.."Add:Rd:Sudo:mz:Audioc"..x)
local video_note = Redis:get(BrAnD.."Add:Rd:Sudo:mz:video_note"..x)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(BrAnD..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
...
Redis:set(BrAnD.."Set:Rd:mz"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(BrAnD.."Set:On:mz"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
local list = Redis:smembers(BrAnD.."List:Rd:Sudo:mz")
for k,v in pairs(list) do
Redis:del(BrAnD.."Add:Rd:Sudo:mz:Gif"..v)
Redis:del(BrAnD.."Add:Rd:Sudo:mz:vico"..v)
Redis:del(BrAnD.."Add:Rd:Sudo:mz:stekr"..v)
Redis:del(BrAnD.."Add:Rd:Sudo:mz:Text"..v)
Redis:del(BrAnD.."Add:Rd:Sudo:mz:Photo"..v)
Redis:del(BrAnD.."Add:Rd:Sudo:mz:Photoc"..v)
Redis:del(BrAnD.."Add:Rd:Sudo:mz:Video"..v)
Redis:del(BrAnD.."Add:Rd:Sudo:mz:Videoc"..v)
Redis:del(BrAnD.."Add:Rd:Sudo:mz:File"..v)
Redis:del(BrAnD.."Add:Rd:Sudo:mz:Audio"..v)
Redis:del(BrAnD.."Add:Rd:Sudo:mz:Audioc"..v)
Redis:del(BrAnD.."Add:Rd:Sudo:mz:video_note"..v)
Redis:del(BrAnD.."List:Rd:Sudo:mz")
end
...
for k,v in pairs(list) do
if Redis:get(BrAnD.."Add:Rd:Sudo:mz:Gif"..v) then
db = "متحركه ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Sudo:mz:vico"..v) then
db = "بصمه ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Sudo:mz:stekr"..v) then
db = "ملصق ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Sudo:mz:Text"..v) then
db = "رساله ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Sudo:mz:Photo"..v) then
db = "صوره ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Sudo:mz:Video"..v) then
db = "فيديو ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Sudo:mz:File"..v) then
db = "ملف ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Sudo:mz:Audio"..v) then
db = "اغنيه ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Sudo:mz:video_note"..v) then
db = "بصمه فيديو ↯︙"
end
text = text..""..k.." - {"..v.."} - {"..db.."}\n"
end
...
Redis:del(BrAnD..'3dd:klm'..msg.chat_id)
...
if i and j then
Redis:sadd(BrAnD..'3dd:klm'..msg.chat_id,mg)
x = string.sub(tx, i,j)
send(msg_chat_id,mg,".","html",true)
end
end
end
list = Redis:smembers(BrAnD..'3dd:klm'..msg.chat_id)
...
Redis:del(BrAnD..'3dd:klm:ms'..msg.chat_id)
...
i ,j = string.find(tx, mt)
if i and j then
Redis:sadd(BrAnD..'3dd:klm:ms'..msg.chat_id,mg)
LuaTele.deleteMessages(data.chat_id,{[1]= mg})
end
end
end
list = Redis:smembers(BrAnD..'3dd:klm:ms'..msg.chat_id)
...
if text == ("مسح الردود الانلاين العامه") then
  ...
  local list = Redis:smembers(BrAnD.."List:Manager:inline3am")
  for k,v in pairs(list) do
      Redis:del(BrAnD.."Add:Rd:Manager:Gif:inline3am"..v)   
      Redis:del(BrAnD.."Add:Rd:Manager:Vico:inline3am"..v)   
      Redis:del(BrAnD.."Add:Rd:Manager:Stekrs:inline3am"..v)     
      Redis:del(BrAnD.."Add:Rd:Manager:Text:inline3am"..v)   
      Redis:del(BrAnD.."Add:Rd:Manager:Photo:inline3am"..v)
      Redis:del(BrAnD.."Add:Rd:Manager:Photoc:inline3am"..v)
      Redis:del(BrAnD.."Add:Rd:Manager:Video:inline3am"..v)
      Redis:del(BrAnD.."Add:Rd:Manager:Videoc:inline3am"..v)  
      Redis:del(BrAnD.."Add:Rd:Manager:File:inline3am"..v)
      Redis:del(BrAnD.."Add:Rd:Manager:video_note:inline3am"..v)
      Redis:del(BrAnD.."Add:Rd:Manager:Audio:inline3am"..v)
      Redis:del(BrAnD.."Add:Rd:Manager:Audioc:inline3am"..v)
      Redis:del(BrAnD.."Rd:Manager:inline3am:v"..v)
      Redis:del(BrAnD.."Rd:Manager:inline3am:link"..v)
  Redis:del(BrAnD.."List:Manager:inline3am")
  end
  return send(msg_chat_id,msg_id,"↯︙ تم مسح قائمه الانلاين","md",true)  
  end
if text and Redis:get(BrAnD.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id) == "set_link" then
Redis:del(BrAnD.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id)
local anubis = Redis:get(BrAnD.."Text:Manager:inline3am"..msg.sender.user_id..":")
Redis:set(BrAnD.."Rd:Manager:inline3am:link"..anubis, text)
send(msg_chat_id,msg_id,"↯︙ تم اضافه الرد بنجاح","md",true)  
return false  
end
if text and Redis:get(BrAnD.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id) == "set_inline" then
Redis:set(BrAnD.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id, "set_link")
local anubis = Redis:get(BrAnD.."Text:Manager:inline3am"..msg.sender.user_id..":")
Redis:set(BrAnD.."Rd:Manager:inline3am:text"..anubis, text)
send(msg_chat_id,msg_id,"↯︙ الان ارسل الرابط","md",true)  
return false  
end
if Redis:get(BrAnD.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id) == "true1" and tonumber(msg.sender.user_id) ~= tonumber(BrAnD) then
Redis:del(BrAnD.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id)
Redis:set(BrAnD.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id,"set_inline")
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local anubis = Redis:get(BrAnD.."Text:Manager:inline3am"..msg.sender.user_id..":")
if msg.content.text then   
text = text:gsub('"',"") 
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(BrAnD.."Add:Rd:Manager:Text:inline3am"..anubis, text)
elseif msg.content.sticker then   
Redis:set(BrAnD.."Add:Rd:Manager:Stekrs:inline3am"..anubis, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(BrAnD.."Add:Rd:Manager:Vico:inline3am"..anubis, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(BrAnD.."Add:Rd:Manager:Audio:inline3am"..anubis, msg.content.audio.audio.remote.id)  
Redis:set(BrAnD.."Add:Rd:Manager:Audioc:inline3am"..anubis, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(BrAnD.."Add:Rd:Manager:File:inline3am"..anubis, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(BrAnD.."Add:Rd:Manager:Gif:inline3am"..anubis, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(BrAnD.."Add:Rd:Manager:video_note:inline3am"..anubis, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(BrAnD.."Add:Rd:Manager:Video:inline3am"..anubis, msg.content.video.video.remote.id)  
Redis:set(BrAnD.."Add:Rd:Manager:Videoc:inline3am"..anubis, msg.content.caption.text)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(BrAnD.."Add:Rd:Manager:Photo:inline3am"..anubis, idPhoto)  
Redis:set(BrAnD.."Add:Rd:Manager:Photoc:inline3am"..anubis, msg.content.caption.text)  
end
send(msg_chat_id,msg_id,"↯︙ الان ارسل الكلام داخل الزر","md",true)  
return false  
end  
...
if text and text:match("^(.*)$") then
if Redis:get(BrAnD.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
if not Redis:sismember(BrAnD.."List:Manager:inline3am", text) then
 Redis:del(BrAnD.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id.."")
   return send(msg_chat_id,msg_id,"↯︙ لا يوجد رد لهذه الكلمه","md",true)  
  end
  Redis:del(BrAnD.."Add:Rd:Manager:Gif:inline3am"..text)   
  Redis:del(BrAnD.."Add:Rd:Manager:Vico:inline3am"..text)   
  Redis:del(BrAnD.."Add:Rd:Manager:Stekrs:inline3am"..text)     
  Redis:del(BrAnD.."Add:Rd:Manager:Text:inline3am"..text)   
  Redis:del(BrAnD.."Add:Rd:Manager:Photo:inline3am"..text)
  Redis:del(BrAnD.."Add:Rd:Manager:Photoc:inline3am"..text)
  Redis:del(BrAnD.."Add:Rd:Manager:Video:inline3am"..text)
  Redis:del(BrAnD.."Add:Rd:Manager:Videoc:inline3am"..text)  
  Redis:del(BrAnD.."Add:Rd:Manager:File:inline3am"..text)
  Redis:del(BrAnD.."Add:Rd:Manager:video_note:inline3am"..text)
  Redis:del(BrAnD.."Add:Rd:Manager:Audio:inline3am"..text)
  Redis:del(BrAnD.."Add:Rd:Manager:Audioc:inline3am"..text)
  Redis:del(BrAnD.."Rd:Manager:inline3am:text"..text)
  Redis:del(BrAnD.."Rd:Manager:inline3am:link"..text)
Redis:del(BrAnD.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id.."")
Redis:srem(BrAnD.."List:Manager:inline3am", text)
send(msg_chat_id,msg_id,"↯︙ تم حذف الرد من الردود الانلاين العامه","md",true)  
return false
end
end
if text and text:match("^(.*)$") and tonumber(msg.sender.user_id) ~= tonumber(BrAnD) then
  if Redis:get(BrAnD.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id) == "true" then
  Redis:set(BrAnD.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id,"true1")
  Redis:set(BrAnD.."Text:Manager:inline3am"..msg.sender.user_id..":", text)
  Redis:del(BrAnD.."Add:Rd:Manager:Gif:inline3am"..text)   
  Redis:del(BrAnD.."Add:Rd:Manager:Vico:inline3am"..text)   
  Redis:del(BrAnD.."Add:Rd:Manager:Stekrs:inline3am"..text)     
  Redis:del(BrAnD.."Add:Rd:Manager:Text:inline3am"..text)   
  ...
  Redis:del(BrAnD.."Rd:Manager:inline3am:text"..text)
  Redis:del(BrAnD.."Rd:Manager:inline3am:link"..text)
  Redis:sadd(BrAnD.."List:Manager:inline3am", text)
  send(msg_chat_id,msg_id,[[
  ↯︙ارسل لي الرد سواء كان 
  ❨ ملف ، ملصق ، متحركه ، صوره
   ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if text == "اضف رد انلاين عام" then
  ...
  Redis:set(BrAnD.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id,true)
  local reply_markup = LuaTele.replyMarkup{
  type = 'inline',
  data = {
  {
...
if text and not Redis:get(BrAnD.."Status:Reply:inline3am"..msg_chat_id) then
local btext = Redis:get(BrAnD.."Rd:Manager:inline3am:text"..text)
local blink = Redis:get(BrAnD.."Rd:Manager:inline3am:link"..text)
local anemi = Redis:get(BrAnD.."Add:Rd:Manager:Gif:inline3am"..text)   
local veico = Redis:get(BrAnD.."Add:Rd:Manager:Vico:inline3am"..text)   
local stekr = Redis:get(BrAnD.."Add:Rd:Manager:Stekrs:inline3am"..text)     
local Texingt = Redis:get(BrAnD.."Add:Rd:Manager:Text:inline3am"..text)   
local photo = Redis:get(BrAnD.."Add:Rd:Manager:Photo:inline3am"..text)
local photoc = Redis:get(BrAnD.."Add:Rd:Manager:Photoc:inline3am"..text)
local video = Redis:get(BrAnD.."Add:Rd:Manager:Video:inline3am"..text)
local videoc = Redis:get(BrAnD.."Add:Rd:Manager:Videoc:inline3am"..text)  
local document = Redis:get(BrAnD.."Add:Rd:Manager:File:inline3am"..text)
local audio = Redis:get(BrAnD.."Add:Rd:Manager:Audio:inline3am"..text)
local audioc = Redis:get(BrAnD.."Add:Rd:Manager:Audioc:inline3am"..text)
local video_note = Redis:get(BrAnD.."Add:Rd:Manager:video_note:inline3am"..text)
local reply_markup = LuaTele.replyMarkup{
  type = 'inline',
  data = {
  {
...
if text == "حذف رد انلاين عام" then
  ...
  Redis:set(BrAnD.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id,"true2")
  return send(msg_chat_id,msg_id,"↯︙ ارسل الان الكلمه لحذفها من الردود الانلاين","md",false, false, false, false, reply_markup)
  end 
...
if text == ("الردود الانلاين العامه") then
  ...
  text = "↯︙ قائمه الردود الانلاين \n- - - - - - - - -\n"
  for k,v in pairs(list) do
  if Redis:get(BrAnD.."Add:Rd:Manager:Gif:inline3am"..v) then
  db = "متحركه ↯︙"
  elseif Redis:get(BrAnD.."Add:Rd:Manager:Vico:inline3am"..v) then
  db = "بصمه ↯︙"
  elseif Redis:get(BrAnD.."Add:Rd:Manager:Stekrs:inline3am"..v) then
  db = "ملصق ↯︙"
  elseif Redis:get(BrAnD.."Add:Rd:Manager:Text:inline3am"..v) then
  db = "رساله ↯︙"
  elseif Redis:get(BrAnD.."Add:Rd:Manager:Photo:inline3am"..v) then
  db = "صوره ↯︙"
  elseif Redis:get(BrAnD.."Add:Rd:Manager:Video:inline3am"..v) then
  db = "فيديو ↯︙"
  elseif Redis:get(BrAnD.."Add:Rd:Manager:File:inline3am"..v) then
  db = "ملف ↯︙"
  elseif Redis:get(BrAnD.."Add:Rd:Manager:Audio:inline3am"..v) then
  db = "اغنيه ↯︙"
  elseif Redis:get(BrAnD.."Add:Rd:Manager:video_note:inline3am"..v) then
  db = "بصمه فيديو ↯︙"
  end
  text = text..""..k.." - {"..v.."} - {"..db.."}\n"
  end
...
Redis:sadd(BrAnD..'ban:online',txx)
...
if txx:match("^-100(%d+)$") then
Redis:srem(BrAnD..'ban:online',txx)
...
LuaTele.sendAudio(msg_chat_id,msg_id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@LLQLLIL")
sleep(1)
...
balas = 10
if Redis:sismember(BrAnD.."booob",msg.sender.user_id) then
return send(msg.chat_id,msg.id, "•  لديك حساب بنكي مسبقاً\n\n•  لعرض معلومات حسابك اكتب\n⇠ `حسابي`","md",true)
end
Redis:setex(BrAnD.."booobb" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
send(msg.chat_id,msg.id,[[
...
if Redis:get(BrAnD.."booobb" .. msg.chat_id .. ":" .. msg.sender.user_id) then
if text == "ماستر" then
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
news = ""..ban.first_name..""
...
Redis:set(BrAnD.."bobna"..msg.sender.user_id,news)
Redis:set(BrAnD.."boob"..msg.sender.user_id,balas)
Redis:set(BrAnD.."boobb"..msg.sender.user_id,creditcc)
Redis:set(BrAnD.."bbobb"..msg.sender.user_id,text)
Redis:set(BrAnD.."boballname"..creditcc,news)
Redis:set(BrAnD.."boballbalc"..creditcc,balas)
Redis:set(BrAnD.."boballcc"..creditcc,creditcc)
Redis:set(BrAnD.."boballban"..creditcc,text)
Redis:set(BrAnD.."boballid"..creditcc,banid)
Redis:sadd(BrAnD.."booob",msg.sender.user_id)
Redis:del(BrAnD.."booobb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
send(msg.chat_id,msg.id, "\n• وسوينا لك حساب في بنك براند 🏦\n• وشحنالك 10 دولار 💵 هدية\n\n•  رقم حسابك ↢ ( `"..creditcc.."` )\n•  نوع البطاقة ↢ ( ماستر 💳 )\n•  فلوسك ↢ ( 10 دولار 💵 )  ","md",true)  
end 
if text == "فيزا" then
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
...
Redis:set(BrAnD.."bobna"..msg.sender.user_id,news)
Redis:set(BrAnD.."boob"..msg.sender.user_id,balas)
Redis:set(BrAnD.."boobb"..msg.sender.user_id,creditvi)
Redis:set(BrAnD.."bbobb"..msg.sender.user_id,text)
Redis:set(BrAnD.."boballname"..creditvi,news)
Redis:set(BrAnD.."boballbalc"..creditvi,balas)
Redis:set(BrAnD.."boballcc"..creditvi,creditvi)
Redis:set(BrAnD.."boballban"..creditvi,text)
Redis:set(BrAnD.."boballid"..creditvi,banid)
Redis:sadd(BrAnD.."booob",msg.sender.user_id)
Redis:del(BrAnD.."booobb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
send(msg.chat_id,msg.id, "\n• وسوينا لك حساب في بنك براند 🏦\n• وشحنالك 10 دولار 💵 هدية\n\n•  رقم حسابك ↢ ( `"..creditvi.."` )\n•  نوع البطاقة ↢ ( فيزا 💳 )\n•  فلوسك ↢ ( 10 دولار 💵 )  ","md",true)   
end 
...
Redis:set(BrAnD.."bobna"..msg.sender.user_id,news)
Redis:set(BrAnD.."boob"..msg.sender.user_id,balas)
Redis:set(BrAnD.."boobb"..msg.sender.user_id,creditex)
Redis:set(BrAnD.."bbobb"..msg.sender.user_id,text)
Redis:set(BrAnD.."boballname"..creditex,news)
Redis:set(BrAnD.."boballbalc"..creditex,balas)
Redis:set(BrAnD.."boballcc"..creditex,creditex)
Redis:set(BrAnD.."boballban"..creditex,text)
Redis:set(BrAnD.."boballid"..creditex,banid)
Redis:sadd(BrAnD.."booob",msg.sender.user_id)
Redis:del(BrAnD.."booobb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
send(msg.chat_id,msg.id, "\n• وسوينا لك حساب في بنك براند 🏦\n• وشحنالك 10 دولار 💵 هدية\n\n•  رقم حسابك ↢ ( `"..creditex.."` )\n•  نوع البطاقة ↢ ( اكسبرس 💳 )\n•  فلوسك ↢ ( 10 دولار 💵 )  ","md",true)   
end 
end
if text == 'لعبة بنك' or text == 'لعبه بنك' or text =='لعبه البنك' or text =='لعبة البنك' or text == "البنك" or text == "بنك" then
local txx = [[
٠ اوامر لعبة البنك
...
if Redis:sismember(BrAnD.."booob",msg.sender.user_id) then
Redis:srem(BrAnD.."booob", msg.sender.user_id)
Redis:del(BrAnD.."boob"..msg.sender.user_id)
Redis:del(BrAnD.."boobb"..msg.sender.user_id)
Redis:del(BrAnD.."zrfff"..msg.sender.user_id)
Redis:srem(BrAnD.."zrfffid", msg.sender.user_id)
...
if msg.ControllerBot then
Redis:del(BrAnD.."booob")
Redis:del(BrAnD.."boob")
Redis:del(BrAnD.."boobb")
Redis:del(BrAnD.."zrfff")
Redis:del(BrAnD.."zrfffid")
...
if Redis:sismember(BrAnD.."booob",msg.sender.user_id) then
ballancee = Redis:get(BrAnD.."boob"..msg.sender.user_id) or 0
...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n*•  براند ماعنده حساب بالبنك 🤣*","md",true)  
return false
end
if Redis:sismember(BrAnD.."booob",Remsg.sender.user_id) then
ballanceed = Redis:get(BrAnD.."boob"..Remsg.sender.user_id) or 0
...
if Redis:sismember(BrAnD.."booob",msg.sender.user_id) then
cccc = Redis:get(BrAnD.."boobb"..msg.sender.user_id)
uuuu = Redis:get(BrAnD.."bbobb"..msg.sender.user_id)
pppp = Redis:get(BrAnD.."zrfff"..msg.sender.user_id) or 0
ballancee = Redis:get(BrAnD.."boob"..msg.sender.user_id) or 0
...
if Redis:sismember(BrAnD.."booob",Remsg.sender.user_id) then
ccccc = Redis:get(BrAnD.."boobb"..Remsg.sender.user_id)
uuuuu = Redis:get(BrAnD.."bbobb"..Remsg.sender.user_id)
ppppp = Redis:get(BrAnD.."zrfff"..Remsg.sender.user_id) or 0
ballanceed = Redis:get(BrAnD.."boob"..Remsg.sender.user_id) or 0
Redis:srem(BrAnD.."booob", Remsg.sender.user_id)
Redis:del(BrAnD.."boob"..Remsg.sender.user_id)
Redis:del(BrAnD.."boobb"..Remsg.sender.user_id)
Redis:del(BrAnD.."zrfff"..Remsg.sender.user_id)
Redis:srem(BrAnD.."zrfffid", Remsg.sender.user_id)
...
if Redis:sismember(BrAnD.."booob",coniss) then
ccccc = Redis:get(BrAnD.."boobb"..coniss)
uuuuu = Redis:get(BrAnD.."bbobb"..coniss)
ppppp = Redis:get(BrAnD.."zrfff"..coniss) or 0
ballanceed = Redis:get(BrAnD.."boob"..coniss) or 0
Redis:srem(BrAnD.."booob", coniss)
Redis:del(BrAnD.."boob"..coniss)
Redis:del(BrAnD.."boobb"..coniss)
Redis:del(BrAnD.."zrfff"..coniss)
Redis:srem(BrAnD.."zrfffid", coniss)
send(msg.chat_id,msg.id, "•  الاسم ↢ "..news.."\n•  الحساب ↢ `"..ccccc.."`\n•  بنك ↢ ( براند )\n•  نوع ↢ ( "..uuuuu.." )\n•  الرصيد ↢ ( "..ballanceed.." دولار 💵 )\n•  الزرف ↢ ( "..ppppp.." دولار 💵 )\n•  مسكين مسحت حسابه \n.","md",true)
else
send(msg.chat_id,msg.id, "•  ماعنده حساب بنكي اصلاً ","md",true)
end
...
local coniss = coniss:gsub('٩','9')
local coniss = tonumber(coniss)
if Redis:get(BrAnD.."boballcc"..coniss) then
local yty = Redis:get(BrAnD.."boballname"..coniss)
local dfhb = Redis:get(BrAnD.."boballbalc"..coniss)
local fsvhh = Redis:get(BrAnD.."boballban"..coniss)
...
local coniss = tonumber(coniss)
if Redis:sismember(BrAnD.."booob",msg.sender.user_id) then
if Redis:get(BrAnD.."iiooooo" .. msg.sender.user_id) then
local time_ex = ctime(Redis:ttl(BrAnD.."iiooooo" .. msg.sender.user_id))
return send(msg.chat_id,msg.id,"•  مايمديك تضارب الان\n•  تعال بعد ( "..time_ex.." )","md",true)
end
ballancee = Redis:get(BrAnD.."boob"..msg.sender.user_id) or 0
...
Redis:set(BrAnD.."boob"..msg.sender.user_id , math.floor(ballanceekkku))
Redis:setex(BrAnD.."iiooooo" .. msg.sender.user_id,1200, true)
...
local coniss = tonumber(coniss)
if Redis:sismember(BrAnD.."booob",msg.sender.user_id) then
if Redis:get(BrAnD.."iioooo" .. msg.sender.user_id) then
local time_ex = ctime(Redis:ttl(BrAnD.."iioooo" .. msg.sender.user_id))
return send(msg.chat_id,msg.id,"•  مايمديك تستثمر الان\n•  تعال بعد ( "..time_ex.." )","md",true)
end
ballancee = Redis:get(BrAnD.."boob"..msg.sender.user_id) or 0
if tonumber(coniss) < 99 then
return send(msg.chat_id,msg.id, "•  الحد الادنى المسموح هو 100 دولار 💵\n.","md",true)
...
Redis:incrby(BrAnD.."boob"..msg.sender.user_id , math.floor(ballanceekk))
Redis:setex(BrAnD.."iioooo" .. msg.sender.user_id,1200, true)
...
local coniss = tonumber(coniss)
if Redis:sismember(BrAnD.."booob",msg.sender.user_id) then
if Redis:get(BrAnD.."iiooo" .. msg.sender.user_id) then
local time_ex = ctime(Redis:ttl(BrAnD.."iiooo" .. msg.sender.user_id)) 
return send(msg.chat_id,msg.id,"•  مايمديك تلعب لعبة الحظ الان\n•  تعال بعد ( "..time_ex.." )","md",true)
end
ballancee = Redis:get(BrAnD.."boob"..msg.sender.user_id) or 0
if tonumber(ballancee) < tonumber(coniss) then
return send(msg.chat_id,msg.id, "•  فلوسك ماتكفي \n.","md",true)
...
Redis:incrby(BrAnD.."boob"..msg.sender.user_id , coniss)
Redis:setex(BrAnD.."iiooo" .. msg.sender.user_id,1200, true)
...
Redis:decrby(BrAnD.."boob"..msg.sender.user_id , coniss)
Redis:setex(BrAnD.."iiooo" .. msg.sender.user_id,1200, true)
...
local coniss = coniss:gsub('-','')
local coniss = tonumber(coniss)
if not Redis:sismember(BrAnD.."booob",msg.sender.user_id) then
...
Redis:set(BrAnD.."transn"..msg.sender.user_id,coniss)
Redis:setex(BrAnD.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
send(msg.chat_id,msg.id,[[
...
if Redis:get(BrAnD.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) then
cccc = Redis:get(BrAnD.."boobb"..msg.sender.user_id)
uuuu = Redis:get(BrAnD.."bbobb"..msg.sender.user_id)
if text ~= text:match('^(%d+)$') then
Redis:del(BrAnD.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
Redis:del(BrAnD.."transn" .. msg.sender.user_id)
...
if Redis:get(BrAnD.."boballcc"..text) then
local UserNamey = Redis:get(BrAnD.."transn"..msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
local fsvhhh = Redis:get(BrAnD.."boballid"..text)
...
local fsvhh = Redis:get(BrAnD.."boballban"..text)
UserNameyr = UserNamey / 10
UserNameyy = UserNamey - UserNameyr
Redis:decrby(BrAnD.."boob"..msg.sender.user_id , UserNamey)
Redis:incrby(BrAnD.."boob"..fsvhhh , math.floor(UserNameyy))
send(msg.chat_id,msg.id, "حوالة صادرة من بنك براند\n\nالمرسل : "..news.."\nالحساب رقم : `"..cccc.."`\nنوع البطاقة : "..uuuu.."\nالمستلم : "..newss.."\nالحساب رقم : `"..text.."`\nنوع البطاقة : "..fsvhh.."\nخصمت 10% رسوم تحويل\nالمبلغ : "..UserNameyy.." دولار 💵","md",true)
send(fsvhhh,0, "حوالة واردة من بنك براند\n\nالمرسل : "..news.."\nالحساب رقم : `"..cccc.."`\nنوع البطاقة : "..uuuu.."\nالمبلغ : "..UserNameyy.." دولار 💵","md",true)
Redis:del(BrAnD.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
Redis:del(BrAnD.."transn" .. msg.sender.user_id)
else
send(msg.chat_id,msg.id, "•  مافيه حساب بنكي كذا","md",true)
...
if Redis:sismember(BrAnD.."booob",Remsg.sender.user_id) then
Redis:incrby(BrAnD.."boob"..Remsg.sender.user_id , coniss)
ccccc = Redis:get(BrAnD.."boobb"..Remsg.sender.user_id)
uuuuu = Redis:get(BrAnD.."bbobb"..Remsg.sender.user_id)
ppppp = Redis:get(BrAnD.."zrfff"..Remsg.sender.user_id) or 0
ballanceed = Redis:get(BrAnD.."boob"..Remsg.sender.user_id) or 0
...
if Redis:sismember(BrAnD.."booob",Remsg.sender.user_id) then
Redis:decrby(BrAnD.."boob"..Remsg.sender.user_id , coniss)
ccccc = Redis:get(BrAnD.."boobb"..Remsg.sender.user_id)
uuuuu = Redis:get(BrAnD.."bbobb"..Remsg.sender.user_id)
ppppp = Redis:get(BrAnD.."zrfff"..Remsg.sender.user_id) or 0
ballanceed = Redis:get(BrAnD.."boob"..Remsg.sender.user_id) or 0
...
local bank_users = Redis:smembers(BrAnD.."booob")
...
local mony = Redis:get(BrAnD.."boob"..v)
...
local ty_users = Redis:smembers(BrAnD.."zrfffid")
if #ty_users == 0 then
...
local mony = Redis:get(BrAnD.."zrfff"..v)
...
if Redis:sismember(BrAnD.."booob",msg.sender.user_id) then
if Redis:get(BrAnD.."iioo" .. msg.sender.user_id) then
local time_ex = ctime(Redis:ttl(BrAnD.."iioo" .. msg.sender.user_id))
return send(msg.chat_id,msg.id,"•  من شوي اخذت بخشيش استنى ( "..time_ex.." )","md",true)
end
local jjjo = math.random(1,200);
Redis:incrby(BrAnD.."boob"..msg.sender.user_id , jjjo)
send(msg.chat_id,msg.id,"•  تكرم وهي بخشيش "..jjjo.." دولار 💵","md",true)
Redis:setex(BrAnD.."iioo" .. msg.sender.user_id,600, true)
else
send(msg.chat_id,msg.id, "•  ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:get(BrAnD.."polic" .. msg.sender.user_id) then
local time_ex = ctime(Redis:ttl(BrAnD.."polic" .. msg.sender.user_id))
return send(msg.chat_id,msg.id,"•  انتا بالسجن 🏤 استنى ( "..time_ex.." )","md",true)
end
if Redis:get(BrAnD.."hrame" .. Remsg.sender.user_id) then
local time_ex = ctime(Redis:ttl(BrAnD.."hrame" .. Remsg.sender.user_id))
...
local ballanceed = Redis:get(BrAnD.."boob"..Remsg.sender.user_id) or 0
Redis:incrby(BrAnD.."boob"..msg.sender.user_id , hrame)
Redis:decrby(BrAnD.."boob"..Remsg.sender.user_id , hrame)
Redis:setex(BrAnD.."hrame" .. Remsg.sender.user_id,900, true)
Redis:incrby(BrAnD.."zrfff"..msg.sender.user_id,hrame)
Redis:sadd(BrAnD.."zrfffid",msg.sender.user_id)
send(msg.chat_id,msg.id, "•  خذ يالحرامي زرفته "..hrame.." دولار 💵\n.","md",true)
else
Redis:setex(BrAnD.."polic" .. msg.sender.user_id,300, true)
...
if Redis:sismember(BrAnD.."booob",msg.sender.user_id) then
if Redis:get(BrAnD.."iiioo" .. msg.sender.user_id) then
local time_ex = ctime(Redis:ttl(BrAnD.."iiioo" .. msg.sender.user_id))
...
if job == "طيار" then
Redis:incrby(BrAnD.."boob"..msg.sender.user_id , 500)
ratbk = "500"
your_job = "طيار 🚀"
elseif job == "محامي" then
Redis:incrby(BrAnD.."boob"..msg.sender.user_id , 300)
ratbk = "300"
your_job = "محامي 👨‍🎓"
elseif job == "دكتور" then
Redis:incrby(BrAnD.."boob"..msg.sender.user_id , 600)
ratbk = "600"
your_job = "دكتور 👨‍🔬‍"
elseif job == "خباز" then
Redis:incrby(BrAnD.."boob"..msg.sender.user_id , 100)
ratbk = "100"
your_job = "خباز ‍💆‍♂️"
elseif job == "مدير بنك" then
Redis:incrby(BrAnD.."boob"..msg.sender.user_id , 800)
ratbk = "800"
your_job = "مدير بنك ‍👨‍💼"
elseif job == "قلب ستيفن" then
Redis:incrby(BrAnD.."boob"..msg.sender.user_id , 1000)
ratbk = "1000"
your_job = "قلب ستيفن ♥"
elseif job == "مدرس" then
Redis:incrby(BrAnD.."boob"..msg.sender.user_id , 400)
ratbk = "400"
your_job = "مدرس 🤵"
elseif job == "فتاحه" then
Redis:incrby(BrAnD.."boob"..msg.sender.user_id , 5000)
ratbk = "5000"
your_job = "فتاحه 💋"
end
local ballancee = Redis:get(BrAnD.."boob"..msg.sender.user_id) or 0
send(msg.chat_id,msg.id,"• اشعار ايداع "..neews.."\n• وظيفتك : "..your_job.."\n• المبلغ : "..ratbk.." دولار 💵\n• نوع العملية : اضافة راتب\n• رصيدك الان : "..ballancee.." دولار 💵","md",true)
Redis:setex(BrAnD.."iiioo" .. msg.sender.user_id,600, true)
else
send(msg.chat_id,msg.id, "•  ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if not Redis:sismember(BrAnD.."booob",Remsg.sender.user_id) then
return send(msg.chat_id,msg.id,"• ما عنده حساب بنكي")
end
if Redis:get(BrAnD..'hgomm'..msg.sender.user_id) then
return send(msg.chat_id,msg.id,"• استنا "..ctime(Redis:ttl(BrAnD..'hgomm'..msg.sender.user_id)).." وبعدين هاجم تاني")
end
...
local coniss = coniss:gsub('-','')
local coniss = tonumber(coniss)
local my_balance = Redis:get(BrAnD.."boob"..msg.sender.user_id) or 0
local his_balance = Redis:get(BrAnD.."boob"..Remsg.sender.user_id) or 0
...
Redis:incrby(BrAnD.."boob"..msg.sender.user_id , coniss)
Redis:decrby(BrAnD.."boob"..Remsg.sender.user_id , coniss)
local balance = Redis:get(BrAnD.."boob"..msg.sender.user_id) or 0
local Hbalance = Redis:get(BrAnD.."boob"..Remsg.sender.user_id) or 0
Redis:setex(BrAnD..'hgomm'..msg.sender.user_id,300,true)
...
if text and Redis:get(BrAnD..msg.chat_id..msg.sender.user_id.."txtrtb") then
local balance = Redis:get(BrAnD.."boob"..msg.sender.user_id)
if text == 'مميز' and tonumber(balance)  >= 2000 then
Redis:decrby(BrAnD.."boob"..msg.sender.user_id , 2000)
Redis:sadd(BrAnD.."Special:Group"..msg_chat_id,msg.sender.user_id) 
Redis:del(BrAnD..msg.chat_id..msg.sender.user_id.."txtrtb") 
...
Redis:decrby(BrAnD.."boob"..msg.sender.user_id , 4000)
Redis:sadd(BrAnD.."Admin:Group"..msg_chat_id,msg.sender.user_id) 
Redis:del(BrAnD..msg.chat_id..msg.sender.user_id.."txtrtb") 
...
Redis:decrby(BrAnD.."boob"..msg.sender.user_id , 6000)
Redis:sadd(BrAnD.."Manger:Group"..msg_chat_id,msg.sender.user_id) 
Redis:del(BrAnD..msg.chat_id..msg.sender.user_id.."txtrtb") 
...
Redis:decrby(BrAnD.."boob"..msg.sender.user_id , 8000)
Redis:sadd(BrAnD.."Creator:Group"..msg_chat_id,msg.sender.user_id) 
Redis:del(BrAnD..msg.chat_id..msg.sender.user_id.."txtrtb") 
...
Redis:setex(BrAnD..msg.chat_id..msg.sender.user_id.."txtrtb",180,true)
...
Redis:set(BrAnD..'rdod:sh'..msg.chat_id,true)
...
Redis:del(BrAnD..'rdod:sh'..msg.chat_id)
send(msg_chat_id,msg_id,'\n*↯︙ تم تعطيل ردود السورس * ',"md",true)  
end
if Redis:get(BrAnD..'rdod:sh'..msg.chat_id) then
...
txx = "↯︙ قائمه الردود \n- - - - - - - - -\n"
for k,v in pairs(list) do
if Redis:get(BrAnD.."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه ↯︙"
elseif Redis:get(BrAnD.."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو ↯︙"
end
txx = txx..""..k.." - {"..v.."} - {"..db.."}\n"
end
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/DyLermemz/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "ايه"or text == "قران"or text == "اية" then
Abs = math.random(2,140); 
local Text ='*↯︙️تم اختيار الاية القرانية لك*'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- BrAnD TeAm ٠',url="t.me/LLQLLIL"}},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/TH1BS/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/MoviesBrAnD/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..MsgId.."&parse_mode=markdown") 
end
...
local MsgId = msg.id/2097152/0.5
local MSGID = string.gsub(MsgId,'.0','')
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/DyLerAnmi/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..MsgId.."&parse_mode=markdown") 
end
if text == "صوره" or text == "صورة" or text == "افتار" then 
Abs = math.random(2,140); 
local Text ='*↯︙تم اختيار صوره لك*'
local MsgId = msg.id/2097152/0.5
local MSGID = string.gsub(MsgId,'.0','')
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/DyLerpotho/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..MsgId.."&parse_mode=markdown") 
end
...
local MsgId = msg.id/2097152/0.5
local MSGID = string.gsub(MsgId,'.0','')
https.request("https://api.telegram.org/bot"..Token..'/sendanimation?chat_id=' .. msg.chat_id .. '&animation=https://t.me/KKKKB/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..MsgId.."&parse_mode=markdown") 
end
if text == "الحاسبه" or text == "حاسبه" or text == "الاله الحاسبه" then
Redis:del(BrAnD..msg.sender.user_id..msg.chat_id.."num")
...
send(msg.chat_id,msg.id,"↯︙ اهلا بك في الحاسبة الرقمية الخاصة بسورس براند","md",true, false, false, true, start_mrkup)
return false 
end
...
Redis:set(BrAnD..msg.chat_id..msg.sender.user_id.."replace",true)
...
local list = Redis:smembers(BrAnD.."Words:r")
for k,v in pairs(list) do
Redis:del(BrAnD.."Word:Replace"..v)
end
Redis:del(BrAnD.."Words:r")
...
for k,v in pairs(list) do 
cmdd = Redis:get(BrAnD.."Word:Replace"..v)
txx = txx..k.." - "..v.." -- "..cmdd.."\n"
end
...
local json = json:decode(http.request("https://steeev.ml/api%20s/search_yt.php?search="..URL.escape(search)..""))
local datar = {data = {{text = "‹ BrAnD TeAm ›" , url = 'https://t.me/LLQLLIL'}}}
for i = 1,5 do
...
if text and text:match("^(.*)$") then
if Redis:get(BrAnD.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "truedel" then
Redis:set(BrAnD.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"truefguigf1")
Redis:del(BrAnD.."gamebot:newqus"..msg.chat_id,text)
Redis:srem(BrAnD.."gamebot:new1", text)
return send(msg_chat_id,msg_id, '\nتم مسح السؤال بنجاح') 
end
end

if text and text:match("^(.*)$") then
if Redis:get(BrAnD.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(BrAnD.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true1")
Redis:set(BrAnD.."gamebot:newqus"..msg.chat_id,text)
Redis:sadd(BrAnD.."gamebot:new1", text)
return send(msg_chat_id,msg_id, '\nتم حفظ السؤال بنجاح \n ارسل الجواب الاول') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(BrAnD.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
local quschen = Redis:get(BrAnD.."gamebot:newqus"..msg.chat_id)
Redis:set(BrAnD.."gamebot:newqus:as1"..quschen,text)
Redis:set(BrAnD.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true2")
return send(msg_chat_id,msg_id, ' \n ارسل الجواب الثاني') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(BrAnD.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true2" then
local quschen = Redis:get(BrAnD.."gamebot:newqus"..msg.chat_id)
Redis:set(BrAnD.."gamebot:newqus:as2"..quschen,text)
Redis:set(BrAnD.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true3")
return send(msg_chat_id,msg_id, '\n ارسل الجواب الثالث') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(BrAnD.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true3" then
local quschen = Redis:get(BrAnD.."gamebot:newqus"..msg.chat_id)
Redis:set(BrAnD.."gamebot:newqus:as3"..quschen,text)
Redis:set(BrAnD.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true4")
return send(msg_chat_id,msg_id, '\n ارسل الجواب الرابع') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(BrAnD.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true4" then
local quschen = Redis:get(BrAnD.."gamebot:newqus"..msg.chat_id)
Redis:set(BrAnD.."gamebot:newqus:as0"..quschen,text)
Redis:set(BrAnD.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true44")
return send(msg_chat_id,msg_id, '\nتم حفظ الاجوبه \n ارسل الجواب الصحيح') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(BrAnD.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true44" then
local quschen = Redis:get(BrAnD.."gamebot:newqus"..msg.chat_id)
Redis:set(BrAnD.."gamebot:newqus:as4"..quschen,text)
Redis:set(BrAnD.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true186")
return send(msg_chat_id,msg_id, '\nتم حفظ الجواب الصحيح') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(BrAnD.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "truedel" then
Redis:set(BrAnD.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"truefguigf1")
Redis:del(BrAnD.."lkz:gamebot:newqus"..msg.chat_id,text)
Redis:srem(BrAnD.."lkz:gamebot:new1", text)
send(msg_chat_id,msg_id, '\nتم مسح الغز بنجاح')
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(BrAnD.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(BrAnD.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true1")
Redis:set(BrAnD.."lkz:gamebot:newqus"..msg.chat_id,text)
Redis:sadd(BrAnD.."lkz:gamebot:new1", text)
send(msg_chat_id,msg_id, '\nتم حفظ اللغز بنجاح \n ارسل الجواب الاول')
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(BrAnD.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
local quschen = Redis:get(BrAnD.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(BrAnD.."lkz:gamebot:newqus:as1"..quschen,text)
Redis:set(BrAnD.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true2")
send(msg_chat_id,msg_id, ' \n ارسل الجواب الثاني')
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(BrAnD.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true2" then
local quschen = Redis:get(BrAnD.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(BrAnD.."lkz:gamebot:newqus:as2"..quschen,text)
Redis:set(BrAnD.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true3")
send(msg_chat_id,msg_id, '\n ارسل الجواب الثالث')
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(BrAnD.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true3" then
local quschen = Redis:get(BrAnD.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(BrAnD.."lkz:gamebot:newqus:as3"..quschen,text)
Redis:set(BrAnD.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true44")
send(msg_chat_id,msg_id, ' \n ارسل الجواب الصحيح')
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(BrAnD.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true44" then
local quschen = Redis:get(BrAnD.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(BrAnD.."lkz:gamebot:newqus:as4"..quschen,text)
Redis:set(BrAnD.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true186")
send(msg_chat_id,msg_id, '\nتم حفظ الجواب الصحيح')
return false 
end
end
...
Redis:set(BrAnD.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(BrAnD.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,'truedel')
return send(msg_chat_id,msg_id,"ارسل اللغز الان ")
end
...
local list = Redis:smembers(BrAnD.."lkz:gamebot:new1")
t = "• الالغاز : \n"
for k,v in pairs(list) do
t = t..""..k.."- (["..v.."])\n"
end
...
Redis:del(BrAnD.."lkz:gamebot:new1")
...
if #list ~= 0 then
local quschen = list[math.random(#list)]
local ansar1 = Redis:get(BrAnD.."lkz:gamebot:newqus:as1"..quschen)
local ansar2 = Redis:get(BrAnD.."lkz:gamebot:newqus:as2"..quschen)
local ansar3 = Redis:get(BrAnD.."lkz:gamebot:newqus:as3"..quschen)
local ansar4 = Redis:get(BrAnD.."lkz:gamebot:newqus:as4"..quschen)
...
SuperCreator = Redis:sismember(BrAnD.."SuperCreator:Group"..msg.chat_id,UserId_Info.id) 
Creator = Redis:sismember(BrAnD.."Creator:Group"..msg.chat_id,UserId_Info.id)
Manger = Redis:sismember(BrAnD.."Manger:Group"..msg.chat_id,UserId_Info.id)
Admin = Redis:sismember(BrAnD.."Admin:Group"..msg.chat_id,UserId_Info.id)
Special = Redis:sismember(BrAnD.."Special:Group"..msg.chat_id,UserId_Info.id)
BanGroup = Redis:sismember(BrAnD.."BanGroup:Group"..msg.chat_id,UserId_Info.id)
SilentGroup = Redis:sismember(BrAnD.."SilentGroup:Group"..msg.chat_id,UserId_Info.id)
if BanGroup then
BanGroupz = "✔"
else
BanGroupz = "❌"
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{
{text = 'اساسي :'..SuperCreatorz, data =msg.sender.user_id..'/statusSuperCreatorz/'..UserId_Info.id},{text = 'منشئ :'..Creatorz, data =msg.sender.user_id..'/statusCreatorz/'..UserId_Info.id},
},
{
...
{
{text = 'حظر :'..BanGroupz, data =msg.sender.user_id..'/statusban/'..UserId_Info.id},{text = 'كتم :'..SilentGroupz, data =msg.sender.user_id..'/statusktm/'..UserId_Info.id},
},
{
{text = 'مسح الرتب :', data =msg.sender.user_id..'/statusmem/'..UserId_Info.id},
},
{
{text = '❨اخفاء الامر❩', data ='/delAmr1'}
}
...
return send(msg.chat_id,msg.id,'*\n↯︙ اختر ما تريده من الاسفل لترقية العضو او طرده*',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
SuperCreator = Redis:sismember(BrAnD.."SuperCreator:Group"..msg.chat_id,Message_Reply.sender.user_id) 
Creator = Redis:sismember(BrAnD.."Creator:Group"..msg.chat_id,Message_Reply.sender.user_id)
Manger = Redis:sismember(BrAnD.."Manger:Group"..msg.chat_id,Message_Reply.sender.user_id)
Admin = Redis:sismember(BrAnD.."Admin:Group"..msg.chat_id,Message_Reply.sender.user_id)
Special = Redis:sismember(BrAnD.."Special:Group"..msg.chat_id,Message_Reply.sender.user_id)
BanGroup = Redis:sismember(BrAnD.."BanGroup:Group"..msg.chat_id,Message_Reply.sender.user_id)
SilentGroup = Redis:sismember(BrAnD.."SilentGroup:Group"..msg.chat_id,Message_Reply.sender.user_id)
if BanGroup then
BanGroupz = "✔"
else
BanGroupz = "❌"
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{
{text = 'اساسي :'..SuperCreatorz, data =msg.sender.user_id..'/statusSuperCreatorz/'..Message_Reply.sender.user_id},{text = 'منشئ :'..Creatorz, data =msg.sender.user_id..'/statusCreatorz/'..Message_Reply.sender.user_id},
},
{
...
{
{text = 'حظر :'..BanGroupz, data =msg.sender.user_id..'/statusban/'..Message_Reply.sender.user_id},{text = 'كتم :'..SilentGroupz, data =msg.sender.user_id..'/statusktm/'..Message_Reply.sender.user_id},
},
{
{text = 'مسح الرتب :', data =msg.sender.user_id..'/statusmem/'..Message_Reply.sender.user_id},
},
{
{text = '❨اخفاء الامر❩', data ='/delAmr1'}
}
...
photo = "https://t.me/SSSS_ISS/73"
local T =[[
↯︙Welcome To Source
↯︙[ TeAm. BrAnD ](t.me/LLQLLIL)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '❨Source channel❩', url = "https://t.me/LLQLLIL"}
},
{
{text = '❨Dev Source❩', url = "https://t.me/Q0OO0"},{text = '❨Exp Source❩', url = "https://t.me/LILLLL1L"},
},
{
{text = '❨Tws Source❩', url = "https://t.me/q1z8bot"}
}, 
}
...
{
{text = '❨𝟱❩', data = msg.sender.user_id..'/help5'}, {text = '❨𝟲❩', data = msg.sender.user_id..'/help7'}, 
},
{
{text = '❨ الالعاب ❩', data = msg.sender.user_id..'/help6'}, 
},
{
{text = '❨ قفل/ فتح ❩', data = msg.sender.user_id..'/NoNextSeting'}, {text = '❨ تعطيل/ تفعيل ❩', data = msg.sender.user_id..'/listallAddorrem'}, 
},
{
{text = '‹ BrAnD TeAm ›', url = 't.me/'..chsource..''}, 
},
...
Redis:setex(BrAnD.."Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(BrAnD.."Name:Bot") 
return send(msg_chat_id,msg_id,"↯︙ تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(BrAnD.."Name:Bot") or "براند") then
if Redis:get(BrAnD.."name bot type : ") == "photo" then
  local photo = LuaTele.getUserProfilePhotos(BrAnD)
  local UserInfo = LuaTele.getUser(BrAnD)
  local Name_User = UserInfo.first_name
  ...
  if photo.total_count > 0 then
    local NamesBot = (Redis:get(BrAnD.."Name:Bot") or "براند")
    local NameBots = {
"قلب "..NamesBot ,
"كول حبيبي ؟ شرايود 😂",
...
x = x + 1
Redis:srem(BrAnD..'Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,BrAnD)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
send(Get_Chat.id,0,'*↯︙ البوت عضو في الكروب سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(BrAnD..'ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(BrAnD..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(BrAnD..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(BrAnD..'ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(BrAnD.."Game:Smile"..msg.chat_id,SM)
...
Redis:set(BrAnD.."mshaher"..msg.chat_id,name)
...
if Redis:get(BrAnD.."Status:Games"..msg.chat_id) then
KlamSpeed = {"سحور","سياره","استقبال","قنفذ","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","قهوه","سفينه","براند","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","لعبه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنت","ساحه","جسر"};
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(BrAnD.."Game:Monotonous"..msg.chat_id,name)
...
Redis:set(BrAnD.."Game:Riddles"..msg.chat_id,name)
...
if Redis:get(BrAnD.."Status:Games"..msg.chat_id) then
Redis:del(BrAnD.."Set:Country"..msg.chat_id)
...
Redis:set(BrAnD.."Game:Countrygof"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(BrAnD.."Status:Games"..msg.chat_id) then
Redis:del(BrAnD.."Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(BrAnD.."Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(BrAnD.."Status:Games"..msg.chat_id) then
Redis:del(BrAnD.."Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(BrAnD.."Game:Reflection"..msg.chat_id,name)
...
Redis:set(BrAnD.."Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(BrAnD.."Game:Difference"..msg.chat_id,name)
...
Redis:set(BrAnD.."Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(BrAnD.."Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(BrAnD.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(BrAnD.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,Xnxx )  
...
Redis:incrby(BrAnD.."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف نقاط (%d+)$"))  
...
Redis:incrby(BrAnD.."Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
if text == "نقاطي" then 
local Num = Redis:get(BrAnD.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مط', 'رفع مطور')
Redis:set(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي', 'رفع مطور ثانوي')
Redis:set(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ج', 'زواج')
Redis:set(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..'قف', 'قفل الاشعارات')
Redis:set(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..'فف', 'فتح الاشعارات')
Redis:set(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ر', 'الرابط')
Redis:set(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..'الردود', 'رر')
Redis:set(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تث', 'تثبيت')
Redis:set(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تاك', 'تاك للكل')
Redis:set(BrAnD.."Get:Reides:Commands:Group"..msg_chat_id..":"..'غ', 'غنيلي')
return send(msg_chat_id,msg_id,[[
...
Redis:del(BrAnD.."smsme"..msg.chat_id)
...
Redis:set(BrAnD.."smsme"..msg.chat_id,true)
send(msg.chat_id,msg.id,"↯︙ تم تعطيل سمسمي")
end
if not Redis:get(BrAnD.."smsme"..msg.chat_id) then
if text and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if Message_Reply and Message_Reply.sender and tonumber(Message_Reply.sender.user_id) == tonumber(BrAnD) then
...
if msg and Redis:get(BrAnD.."BrAnD:Tagat"..msg.chat_id) then
if not Redis:get(BrAnD..":"..msg.chat_id..":tag") then
...
Redis:setex(BrAnD..":"..msg.chat_id..":tag",30,true)
...
data = {
{
{text = '( حذف على اي حال )', type = 'requestphone'},
},
}
}
...
local GetLink = Redis:get(BrAnD.."Group:Link"..coree[1]) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{{text =Get_Chat.title, url = GetLink}, },}}
return send(msg_chat_id, msg_id, "↯︙Link Group : \n["..Get_Chat.title.. ']('..GetLink..')', 'md', true, false, false, false, reply_markup)
...
if text and Redis:get(BrAnD..msg.sender.user_id.."hash") and Redis:get(BrAnD..msg.sender.user_id.."num") and Redis:get(BrAnD..msg.sender.user_id..'pass') then
if text == "الغاء" or text == "❨ الغاء ❩" then
Redis:del(BrAnD..msg.sender.user_id.."hash")
Redis:del(BrAnD..msg.sender.user_id.."num")
Redis:del(BrAnD..msg.sender.user_id.."pass")
local k = {
...
local hash = Redis:get(BrAnD..msg.sender.user_id.."hash")
local num = Redis:get(BrAnD..msg.sender.user_id.."num")
local pass = Redis:get(BrAnD..msg.sender.user_id.."pass")
...
if text and Redis:get(BrAnD..msg.sender.user_id.."hash") and Redis:get(BrAnD..msg.sender.user_id.."num") and not Redis:get(BrAnD..msg.sender.user_id..'pass') then
if text == "الغاء" or text == "(الغاء)" then
Redis:del(BrAnD..msg.sender.user_id.."hash")
Redis:del(BrAnD..msg.sender.user_id.."num")
local k = {
...
Redis:set(BrAnD..msg.sender.user_id..'pass',text)
local reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
data = {
{
{text = '(حذف)',type = 'text'},{text = '(الغاء)',type = 'text'},
},
}
}
...
Redis:set(BrAnD..msg.sender.user_id.."hash",json.result.access_hash)
Redis:set(BrAnD..msg.sender.user_id.."num",num)
local reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
data = {
{
...
if text == '/start' then
Redis:sadd(BrAnD..'Num:User:Pv',msg.sender.user_id)  
if not msg.Devss then
local photo = LuaTele.getUserProfilePhotos(BrAnD)
if not Redis:get(BrAnD.."Start:Bot") then
local CmdStart = '*\n↯︙ اهلا بك عزيزي انا بوت '..(Redis:get(BrAnD.."Name:Bot") or "براند")..
'\n↯︙ لحمايه المجموعات ومميزات اخرى'..
'\n↯︙ ارفعني مشرف في مجموعتك وارسل كلمة (تفعيل)'..
'\n↯︙ او اضغط ( /delete ) لحذف حسابك'..
'\n↯︙مطور البوت ← {@'..UserSudo..'}*'
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
{
{text = '❨Dev Source❩', url = 't.me/'..chdevolper..''}, {text = '❨Cha Source❩', url = 't.me/'..chsource..''}, 
},
}
}
...
LuaTele.sendPhoto(msg.chat_id, msg.id, photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id,Redis:get(BrAnD.."Start:Bot"),"md", true, nil, nil, nil, nil, nil, nil, nil, nil, reply_markup )
end
else
local reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
data = {
{
{text = '◂ تغير اسم البوت ◂',type = 'text'},{text = '◂ حذف اسم البوت ◂', type = 'text'},
},
{
{text = '◂ قسم الاذاعة ◂',type = 'text'},{text = '◂ الاحصائيات ◂',type = 'text'},
},
{
{text = '◂ قسم المطورين ◂',type = 'text'},{text = '◂ التفعيل والتعطيل ◂', type = 'text'},
},
{
{text = '◂ قسم الكلايش ◂',type = 'text'},{text = '◂ تغير المطور الاساسي ◂', type = 'text'},
},
{
{text = '◂ قسم الردود ◂',type = 'text'},{text = '◂ قسم البيانات ◂', type = 'text'},
},
{
...
if text == "◂ قسم الردود ◂" then
Redis:del(BrAnD..msg.sender.user_id.."bottoken")
Redis:del(BrAnD..msg.sender.user_id.."botuser")
Redis:del(BrAnD..msg.sender.user_id.."make:bot")
...
{
{text = '٠ تنظيف المشتركين ٠',type = 'text'},{text = '٠ تنظيف المجموعات ٠',type = 'text'},
},
{
{text = '٠ قائمة العام ٠',type = 'text'},{text = '٠ مسح قائمة العام ٠',type = 'text'},
},
{
{text = '◂ رجوع ◂',type = 'text'},
},
...
{
{text = '٠ تفعيل الاذاعه ٠',type = 'text'},{text = '٠ تعطيل الاذاعه ٠',type = 'text'},
},
{
{text = '◂ رجوع ◂',type = 'text'},
},
...
data = {
{
{text = '٠ المطورين الثانويين ٠',type = 'text'},{text = '٠ مسح المطورين الثانويين ٠',type = 'text'},
},
{
{text = '٠ المطورين ٠',type = 'text'},{text = '٠ مسح المطورين ٠',type = 'text'},
},
{
{text = '◂ رجوع ◂',type = 'text'},
},
...
if text == "٠ تفعيل البوت بالصوره ٠" then
  ...
  Redis:set(BrAnD.."name bot type : ", "photo")
...
Redis:set(BrAnD.."name bot type : ", "text")
...
Redis:setex(BrAnD.."Change:Start:Bot"..msg.sender.user_id,300,true) 
...
if not Redis:get(BrAnD.."chmembers") then
return send(msg_chat_id,msg_id,'\n*↯︙ الامر معطل بالفعل* ',"md",true)  
end
Redis:del(BrAnD.."chmembers")
...
if not Redis:get(BrAnD.."chfalse") then
return send(msg_chat_id,msg_id,'\n*↯︙ عذرا عليك تعيين قناه للاشتراك الاجباري اولا* ',"md",true)  
end
Redis:set(BrAnD.."chmembers","on")
...
if Redis:get(BrAnD.."set:chs"..msg.sender.user_id) then
if text then
if text == "الغاء" then
Redis:del(BrAnD.."set:chs"..msg.sender.user_id)
return send(msg_chat_id,msg_id,'تم الغاء الامر بنجاح ',"md",true)  
end
if text:match("^@(.*)$") then
local ch = text:match("^@(.*)$")
Redis:set(BrAnD.."chsource",ch)
Redis:del(BrAnD.."set:chs"..msg.sender.user_id)
send(msg_chat_id,msg_id,'تم حفظ معرف ‹ BrAnD TeAm › ',"md",true)  
dofile('BrAnD.lua')  
else
send(msg_chat_id,msg_id,'المعرف خطأ ',"md",true)  
end
...
if not msg.Devss then
if Redis:get(BrAnD.."TwaslBot") and not Redis:sismember(BrAnD.."BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(BrAnD.."Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(BrAnD.."Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(BrAnD..'BaN:In:Tuasl',Info_User)  
return send(msg_chat_id,msg_id,Reply_Status(Info_User,'↯︙ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(BrAnD..'BaN:In:Tuasl',Info_User)  
...
reply_markup = {
inline_keyboard ={
{{text ="ch", url= "https://t.me/LLQLLIL"}},
}
},
},
}
https.request("https://api.telegram.org/bot"..Token..'/answerInlineQuery?inline_query_id='..data.id..'&switch_pm_text=@Q0OO0&switch_pm_parameter=start&results='..JSON.encode(resuult))
end
if Text and Text:match("(.*)@(.*)") then
...
Redis:srem(BrAnD.."ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(BrAnD..'*'..'-100'..data.supergroup.id..'*')
Redis:del(BrAnD.."List:Manager"..'-100'..data.supergroup.id)
Redis:del(BrAnD.."Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(BrAnD.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(BrAnD.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(BrAnD.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(BrAnD.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(BrAnD.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(BrAnD.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(BrAnD.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(BrAnD.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(BrAnD.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(BrAnD.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(BrAnD.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(BrAnD.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(BrAnD.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(BrAnD.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(BrAnD.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(BrAnD.."PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(BrAnD.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(BrAnD.."PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(BrAnD.."Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(BrAnD) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(BrAnD..'Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if tonumber(Message_Edit.sender.user_id) == 5984712101 then
data.The_Controller = 1
elseif tonumber(Message_Edit.sender.user_id) == 5984712101 then
data.The_Controller = 1
elseif The_ControllerAll(Message_Edit.sender.user_id) == true then  
data.The_Controller = 1
elseif Redis:sismember(BrAnD.."Devss:Groups",Message_Edit.sender.user_id) == true then
data.The_Controller = 2
elseif Redis:sismember(BrAnD.."Dev:Groups",Message_Edit.sender.user_id) == true then
data.The_Controller = 3
elseif Redis:sismember(BrAnD.."Ownerss:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 44
elseif Redis:sismember(BrAnD.."SuperCreator:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 4
elseif Redis:sismember(BrAnD.."Creator:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 5
elseif Redis:sismember(BrAnD.."Manger:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 6
elseif Redis:sismember(BrAnD.."Admin:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 7
elseif Redis:sismember(BrAnD.."Special:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 8
elseif tonumber(Message_Edit.sender.user_id) == tonumber(BrAnD) then
...
Redis:incr(BrAnD..'Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(BrAnD.."Lock:edit"..data.chat_id) then
...
local get = Redis:get(BrAnD..IdUser..ChatId.."num")
if get then
tf = get 
else
tf = "" 
...
local txx = tf..num
Redis:set(BrAnD..IdUser..ChatId.."num",txx)
...
if tonumber(IdUser) == tonumber(sendrr) then
local math = Redis:get(BrAnD..IdUser..ChatId.."num")
if math then
...
Redis:del(BrAnD..IdUser..ChatId.."num")
else
LuaTele.answerCallbackQuery(data.id, "• الامر لا يخصك", true)
end
end
...
Redis:set(BrAnD..IdUser..ChatId.."num",gxx)
...
if tonumber(IdUser) == tonumber(sendrr) then
Redis:del(BrAnD..IdUser..ChatId.."num")
edit(ChatId,Msg_id,"↯︙ تم اعادة تشغيل الحاسبة بنجاح" , 'html', false, false, calc_markup)
else
LuaTele.answerCallbackQuery(data.id, "• الامر لا يخصك", true)
end
end
...
if tonumber(IdUser) == tonumber(sendrr) then
Redis:del(BrAnD..IdUser..ChatId.."num")
edit(ChatId,Msg_id,"↯︙ اهلا بك في الحاسبة الرقمية الخاصة بسورس براند" , 'html', false, false, calc_markup)
else
LuaTele.answerCallbackQuery(data.id, "• الامر لا يخصك", true)
end
end
if tonumber(IdUser) == 5984712101 then
data.The_Controller = 1
elseif tonumber(IdUser) == 5984712101 then
data.The_Controller = 1
elseif The_ControllerAll(IdUser) == true then  
data.The_Controller = 1
elseif Redis:sismember(BrAnD.."Devss:Groups",IdUser) == true then
data.The_Controller = 2
elseif Redis:sismember(BrAnD.."Dev:Groups",IdUser) == true then
data.The_Controller = 3
elseif Redis:sismember(BrAnD.."Ownerss:Group"..ChatId,IdUser) == true then
data.The_Controller = 44
elseif Redis:sismember(BrAnD.."SuperCreator:Group"..ChatId,IdUser) == true then
data.The_Controller = 4
elseif Redis:sismember(BrAnD.."Creator:Group"..ChatId,IdUser) == true then
data.The_Controller = 5
elseif Redis:sismember(BrAnD.."Manger:Group"..ChatId,IdUser) == true then
data.The_Controller = 6
elseif Redis:sismember(BrAnD.."Admin:Group"..ChatId,IdUser) == true then
data.The_Controller = 7
elseif Redis:sismember(BrAnD.."Special:Group"..ChatId,IdUser) == true then
data.The_Controller = 8
elseif tonumber(IdUser) == tonumber(BrAnD) then
data.The_Controller = 9
else
data.The_Controller = 10
end  
...
local id = xd[2]
if tonumber(IdUser) == tonumber(UserId) then
local url = io.popen('curl -s "https://sero-bots.ml/API/YouTubeDl.php?id='..id..'"'):read('*a')
local json = JSON.decode(url)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
Redis:incrby(BrAnD.."Num:Add:Games"..ChatId..IdUser, 1)  
...
if Text and Text:match('(.*)/yes_z/(.*)') then
  ...
  if tonumber(zwga_id) == tonumber(IdUser) then
    local zwga_name = LuaTele.getUser(zwga_id).first_name
    local zwg_name = LuaTele.getUser(zwg_id).first_name
    Redis:set(BrAnD..ChatId..zwga_id.."mtzwga:", zwg_id)
    Redis:set(BrAnD..ChatId..zwg_id.."mtzwga:", zwga_id)
...
if Text and Text:match('(%d+)/zeng') then
  ...
  if tonumber(UserId) == tonumber(IdUser) then
    Redis:set(BrAnD..ChatId..IdUser.."zkrf:", "zeng")
...
if Text and Text:match('(.*)/a(.*)') then
    ...
    local z_text = Redis:get(BrAnD..ChatId..IdUser.."zkrf:text")
    Redis:set(BrAnD..ChatId..IdUser.."zkrf:num", z_num)
    if tonumber(UserId) == tonumber(IdUser) then
...
if Text and Text:match('(.*)/b(.*)') then
      ...
      local z_text = Redis:get(BrAnD..ChatId..IdUser.."zkrf:text")
      local z_save = Redis:get(BrAnD..ChatId..IdUser.."zkrf:num")
      if tonumber(UserId) == tonumber(IdUser) then
        local api = https.request("https://api-jack.ml/api19.php?text="..URL.escape(z_text))
        local zkrf = JSON.decode(api)
        ...
        Redis:del(BrAnD..ChatId..IdUser.."zkrf:text")
        Redis:del(BrAnD..ChatId..IdUser.."zkrf:num")
      end
      end
-- z  emo
...
if Text and Text:match('(%d+)/zar') then
    ...
    if tonumber(UserId) == tonumber(IdUser) then
      Redis:set(BrAnD..ChatId..IdUser.."zkrf:", "zar")
      edit(ChatId, Msg_id, "↯︙Send ur Naeme .\n \n↯︙ارسل اسمك الان ليتم زخرفتة", "md",false)
    end
    end
...
if Text and Text:match('(.*)/no_zw/(.*)') then
  ...
  local zwg_id = anubis[2]
  if tonumber(zwga_id) == tonumber(IdUser) then
    return edit(ChatId, Msg_id, "لعد منين اجيبلك زوجه تزوج","md",false)
  end
end
...
Redis:del(BrAnD.."Set:array:Ssd"..IdUser..":"..ChatId)
Redis:del(BrAnD.."Set:array:rd"..IdUser..":"..ChatId)
Redis:del(BrAnD.."Set:array"..IdUser..":"..ChatId)
Redis:del(BrAnD.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(BrAnD.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(BrAnD.."Set:Rd"..IdUser..":"..ChatId)
Redis:del(BrAnD.."Set:On"..IdUser..":"..ChatId)
Redis:del(BrAnD.."Set:Manager:rd:inline"..IdUser..":"..ChatId)
Redis:del(BrAnD.."Set:On:mz"..IdUser..":"..ChatId)
Redis:del(BrAnD.."Set:Rd:mz"..IdUser..":"..ChatId)
...
if Text and Text:match('(%d+)/cancelkit') then
    ...
    Redis:del(BrAnD.."Set:kit"..IdUser..":"..ChatId)
    edit(ChatId,Msg_id,"تم الغاء الامر بنجاح", 'md', true, false, reply_markup)
    end
    end
...
if Redis:get(BrAnD..'Set:array'..IdUser..':'..ChatId) == 'true1' then
Redis:del(BrAnD..'Set:array'..IdUser..':'..ChatId)
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄʀ BrAnD',url='https://t.me/LLQLLIL'}},
}
...
*]]
Redis:set(BrAnD.."youtube"..IdUser..ChatId,'mp3')
...
↯︙ارسل الاسم الان لاقوم بتحميله لك
*]]
Redis:set(BrAnD.."youtube"..IdUser..ChatId,'mp4')
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:sadd(BrAnD.."ChekBotAdd",UserId[2])
local U = LuaTele.getUser(IdUser)
Redis:set(BrAnD.."Status:Id"..UserId[2],true) ;Redis:del(BrAnD.."Status:Reply"..UserId[2]) ;Redis:del(BrAnD.."Status:ReplySudo"..UserId[2]) ;Redis:set(BrAnD.."Status:BanId"..UserId[2],true) ;Redis:set(BrAnD.."Status:SetId"..UserId[2],true) 
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(BrAnD.."Owners:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(BrAnD.."Admin:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
print(replyy)
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:sadd(BrAnD.."SilentGroup:Group"..ChatId,replyy) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
print(replyy)
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:srem(BrAnD.."SilentGroup:Group"..ChatId,replyy) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
print(replyy)
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:sadd(BrAnD.."BanGroup:Group"..ChatId,replyy) 
...
print(replyy)
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:srem(BrAnD.."BanGroup:Group"..ChatId,replyy) 
...
local Teext = '- [*'..FlterBio(UserInfo.first_name)..'*](tg://user?id='..IdUser..') \n*↯︙احسنت اجابتك صحيحه لقد ربحت ((3) نقاط*'
Redis:incrby(BrAnD.."Num:Add:Games"..ChatId..IdUser,3)  
...
Redis:srem(BrAnD.."Dev:Groups",info[2])
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:srem(BrAnD.."Special:Group"..ChatId,IdUser)
Redis:srem(BrAnD.."Admin:Group"..ChatId,IdUser)
Redis:srem(BrAnD.."Manger:Group"..ChatId,IdUser)
Redis:srem(BrAnD.."Creator:Group"..ChatId,IdUser)
Redis:srem(BrAnD.."SuperCreator:Group"..ChatId,IdUser)
Redis:srem(BrAnD.."Dev:Groups",IdUser) 
Redis:srem(BrAnD.."Ownerss:Group"..ChatId,IdUser)
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(BrAnD.."SuperCreator:Group"..ChatId,UserId[2]) then
Redis:srem(BrAnD.."SuperCreator:Group"..ChatId,UserId[2])
else
Redis:sadd(BrAnD.."SuperCreator:Group"..ChatId,UserId[2])
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then 
if Redis:sismember(BrAnD.."Creator:Group"..ChatId,UserId[2]) then
Redis:srem(BrAnD.."Creator:Group"..ChatId,UserId[2])
else
Redis:sadd(BrAnD.."Creator:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(BrAnD.."Manger:Group"..ChatId,UserId[2]) then
Redis:srem(BrAnD.."Manger:Group"..ChatId,UserId[2])
else
Redis:sadd(BrAnD.."Manger:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(BrAnD.."Admin:Group"..ChatId,UserId[2]) then
Redis:srem(BrAnD.."Admin:Group"..ChatId,UserId[2])
else
Redis:sadd(BrAnD.."Admin:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(BrAnD.."Special:Group"..ChatId,UserId[2]) then
Redis:srem(BrAnD.."Special:Group"..ChatId,UserId[2])
else
Redis:sadd(BrAnD.."Special:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:srem(BrAnD.."Creator:Group"..ChatId,UserId[2])
Redis:srem(BrAnD.."SuperCreator:Group"..ChatId,UserId[2])
Redis:srem(BrAnD.."SilentGroup:Group"..ChatId,UserId[2])
Redis:srem(BrAnD.."BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(BrAnD.."BanGroup:Group"..ChatId,UserId[2]) then
Redis:srem(BrAnD.."BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
else
Redis:sadd(BrAnD.."BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(BrAnD.."SilentGroup:Group"..ChatId,UserId[2]) then
Redis:srem(BrAnD.."SilentGroup:Group"..ChatId,UserId[2])
else
Redis:sadd(BrAnD.."SilentGroup:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
data = {
{
{text = '❨𝟮❩', data = IdUser..'/help2'}, 
},
{
{text = '❨𝟯❩', data = IdUser..'/help3'}, {text = '❨𝟰❩', data = IdUser..'/help4'}, 
},
{
{text = '❨𝟱❩', data = IdUser..'/help5'}, {text = '❨𝟲❩', data = IdUser..'/help7'}, 
},
{
...
*]]
Redis:set(BrAnD.."toar"..IdUser,"on")
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
*]]
Redis:set(BrAnD.."toen"..IdUser,"on")
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
{
{text = '❨ العاب الانلاين ❩', data = IdUser..'/degm'}, 
},
{
{text = '❨رجوع❩', data = IdUser..'/helpall'},
},
...
local TextHelp = [[*
↯︙ أهلا بك في قائمة العاب سورس براند اختر نوع الالعاب 
*]]
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
data = {
{
{text = '( تبديل النجوم ) ', url = 'https://t.me/gamee?game=Switchy'}, {text = '( بايسكلات )', url = 'https://t.me/gamee?game=motofx'}, 
},
{
{text = '( اطلاق النار )', url = 'https://t.me/gamee?game=NeonBlaster'}, {text = '( كرة القدم )', url = 'https://t.me/gamee?game=Footballstar'}, 
},
{
...
local TextHelp = [[*
↯︙ مرحبا بك في الالعاب المتطورة الخاص بسورس براند 
...
{
{text = '❨ قفل/ فتح ❩', data = IdUser..'/NoNextSeting'}, {text = '❨ تعطيل/ تفعيل ❩', data = IdUser..'/listallAddorrem'}, 
},
{
{text = '‹ BrAnD TeAm ›', url = 't.me/'..chsource..''}, 
},
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(BrAnD.."Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(BrAnD.."Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(BrAnD.."Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(BrAnD.."Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BrAnD.."Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(BrAnD.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(BrAnD..''..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(BrAnD.."Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Supcreator:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."Special:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."kholat:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."wtka:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."twhd:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."klb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."mar:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."smb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."2rd:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."3ra:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."8by:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."BanGroup:Group"..ChatId) 
edit(ChatId,Msg_id,"↯︙ تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BrAnD.."SilentGroup:Group"..ChatId) 
